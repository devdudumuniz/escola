...
(1, 'novo_trabalho_de_casa', 'Novo lição de casa enviada', '<p>Oi,</p>\r\n<p>Seu professor of&nbsp;[SUJEITA] criou um novo trabalho de casa para o sistema, as informações são as seguintes:</p>\r\n<p><br />Título&nbsp;: [TÍTULO]</p>\r\n<p>Descrição: [DESCRIPTION]</p>\r\n<p>&nbsp;</p>\r\n<p>Para revisar esta lição de casa, insira seu<strong>Sala de aula virtual</strong>,&nbsp;Seção de lição de casa.</p>', ''),
(2, 'Ausências_de_estudantes', 'abscaso', '<div>Oi&nbsp;<strong>[PAIS]</strong>,</div>\r\n<p>O motivo do correio é notificá -lo que seu apreciável son&nbsp;<strong>[ALUNA]</strong>&nbsp; Não está presente nas aulas hoje, se for uma emergência, entre em contato com o shcool.</p>', ''),
(3, 'Relatórios dos alunos', 'Novo relatório', '<div>\r\n<div>\r\n<p>Oi&nbsp;<strong>[PARENT]</strong>,</p>\r\n<p>Um novo relatório de disciplina foi criado para<strong>[STUDENT]</strong>, Por favor, verifique os relatórios acadêmicos em sua conta.</p>\r\n</div>\r\n</div>', ''),
(4, 'Novo_fatura_pai', 'Nova fatura', '<p>Oi&nbsp;<strong>[PAIS]</strong>,</p>\r\n<p>Uma nova fatura foi criada para <strong>[STUDENT]</strong>,&nbsp;Para ver os detalhes da fatura, insira seu gerenciamento de pagamento em sua conta.</p>', ''),
(5, 'Estudante_nova_fatura', 'Nova fatura', '<p>Oi <strong>[ALUNo]</strong>,</p>\r\n<p>A new invoice has been created with your name, to see the details of the invoice please enter your payment management in your account.</p>', '');
...
(1, 'Painel', 'painel', 'tablero', 'painel de controle', 'डैशबोर्ड', 'Tableau de bord', 'Командна табла', 'لوحة القيادة'),
...
(15, 'Students', 'Students', 'Estudiantes', 'Students', 'छात्र', 'Élèves', 'студенти', 'الطلاب'),
...
(66, 'roll', 'ID da lista', 'ID da lista', 'ID da lista', 'रोल आईडी', 'ID da lista', 'Ролл', 'معرف لفة'),
...
(191, 'students_area', 'Students area', 'Area de estudiantes', 'Área de Students', 'छात्र क्षेत्र', 'Zone étudiante', 'Подручје студената', 'Students area'),
...
(203, 'student_payments', 'Student payments', 'Pagos de estudiantes', 'Pagamentos de Students', 'छात्र भुगतान', 'Paiements aux étudiants', 'Студентска уплата', 'دفعات الطالب'),
...
(242, 'student_attendance_report', 'Student Attendance Report', 'Reporte de asistencia estudiantes', 'Relatório de presença de Students', 'छात्र उपस्थिति रिपोर्ट', 'Rapport de présence des étudiants', 'Извештај о ученику', 'تقرير حضور الطالب'),
...
(285, 'check', 'Check', 'get_phrase('cheque')', 'Check', 'चेक', 'Vérifier', 'Провери', 'التحقق من'),
...
(318, 'for_students', 'For Students', 'Para estudiantes', 'Para Students', 'छात्रों के लिए', 'Pour les étudiants', 'За студенте', 'للطلاب'),
...
(354, 'student_new_invoice', 'New invoice (Students)', 'Nueva factura (Estudiantes)', 'Nova factura (Students)', 'नया चालान (छात्र)', 'Nouvelle facture (étudiants)', 'Нови рачун (студенти)', 'فاتورة جديدة (طلاب)'),
