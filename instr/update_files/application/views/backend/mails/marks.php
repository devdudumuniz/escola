  ...
  <div style="vertical-align: top; padding-bottom:50px;padding-top:50px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);background: #001b3d;" align="center"><a href="#"><img src="<?php echo base_url();?>uploads/<?php echo $this->db->get_where('settings', array('type' => 'logow'))->row()->description;?>" alt="<?php echo $system_name;?>" style="border:none;max-width:75%"></a></div>
    <div style="padding: 40px; background: #fff; overflow-x:auto;">
      <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
        <tbody>
          <tr>
            <td><b><?php echo get_phrase('Estudante');?>:</b> <?php echo $student_name;?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
                  <table style="width:100%;border: 1px solid black;">
                    <tr>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('assunto');?></th>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('professor');?></th>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('marca');?></th>
