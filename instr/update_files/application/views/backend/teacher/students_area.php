                                                      ...
                                                      <div class="row">
                                                          <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                                <div class="form-group label-floating" style="background-color: #fff;">
                                                                    <label class="control-label"><?php echo get_phrase('Procurar aluno');?></label>
                                                  ...
                                                  <div class="card-box widget-user ui-block list">
                                                      <div class="more" style="float:right;">
                                                            ...
                                                            <ul class="more-dropdown">
                                                                <li><a href="<?php echo base_url();?>teacher/view_marks/<?php echo $row['student_id'];?>"><?php echo get_phrase('marcas');?></a></li>
                                                            </ul>
                                                        </div>
                                                    <div>
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                  <div class="card-box widget-user ui-block list">
                                                      <div class="more" style="float:right;">
                                                            <i class="icon-options"></i>    
                                                            <ul class="more-dropdown">
                                                                <li><a href="<?php echo base_url();?>teacher/view_marks/<?php echo $row2['student_id'];?>"><?php echo get_phrase('marcas');?></a></li>
                                                            </ul>
                                                        </div>
                                                    <div>
