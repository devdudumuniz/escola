    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          ...
          <li>
          <a href="<?php echo base_url();?>teacher/grados/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('acadêmico');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>teacher/request/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('permissões');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>teacher/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('calendário');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>teacher/notify/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('notificações');?>">
            <div class="left-menu-icon">
