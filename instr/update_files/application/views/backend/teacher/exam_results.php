...
<div class="content-w">
  ...
  <div class="header-spacer"></div>
    ...
    <div class="os-tabs-controls">
      ...
      <li class="navs-item">
        <a class="navs-links active" href="<?php echo base_url();?>teacher/exam_results/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo get_phrase('resultados');?></span></a>
      </li>
      <li class="navs-item">
            ...
            <tbody>
              <?php foreach ($students_array as $row):?>
                    <tr>
                      ...
                      <td><?php  if ($query->num_rows() > 0){?><a href="<?php echo base_url();?>teacher/online_exam_result/<?php echo $online_exam_id;?>/<?php echo $row['student_id'];?>/" class="btn btn-success btn-sm btn-rounded"><?php echo get_phrase('view_results');?></a><?php } else echo get_phrase('sem_ações');?></td>
                    </tr>
            <?php endforeach; ?>
            </tbody>
  ...
  <div class="col-sm-4">
    <div class="pipeline white lined-secondary">
      ...
      <table class="table table-lightbor table-lightfont">
        ...
        <td>
         <?php $minutes = number_format($online_exam_details['duration']/60,0); echo $minutes;?> <?php echo get_phrase('minutos');?>.
        </td>
        </tr>
        <tr>
        <th>
