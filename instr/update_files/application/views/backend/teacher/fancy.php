...
<?php $fc_info_data = base64_decode($data); $fc_ex = explode("-", $fc_info_data);?>
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options">
            ...
            ?>
            <a href="<?php echo base_url();?>teacher/subject_dashboard/<?php echo base64_encode($fc_ex[0].'-'.$fc_ex[1].'-'.$fancy_row2['subject_id']);?>/"><div class="fancy-selector-option <?php if($fancy_row2['subject_id'] == $fc_ex[2]) echo "ativo";?>">
              <div class="fs-img">
        ...
        <div class="control-block">
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                    ...
                    <a href="<?php echo base_url();?>teacher/message/" class="view-all bg-info"><?php echo get_phrase('ver todas as mensagens');?></a>
                </div>
            </div>
            <div class="control-icon more has-items">
                ...
                ?>
                  ...
                  <?php endforeach;?>
                    ...
                    <a href="<?php echo base_url();?>teacher/notifications/" class="view-all bg-info"><?php echo get_phrase('ver todas as notificações');?></a>
                </div>
            </div>
