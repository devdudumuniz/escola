        ...
        <div class="os-tabs-w menu-shad">
	        <div class="os-tabs-controls">
	            <ul class="navs navs-tabs upper">
		            <li class="navs-item">
		                <a class="navs-links active" href="<?php echo base_url();?>techer/student_report/"><i class="os-icon picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i><span><?php echo get_phrase('relatórios');?></span></a>
		            </li>
	            </ul>
	        </div>
        </div>
                    ...
                    <table class="table table-padded">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="bolder">
                                <a href="<?php echo base_url();?>teacher/view_report/<?php echo $row['code'];?>/" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0012_notebook_paper_certificate" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('ver detalhes');?>"></i></a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
