  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/subjects/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('acadêmico');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/request/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('permissões');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('calendário');?>">
            <div class="left-menu-icon">
