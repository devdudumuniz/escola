 ...
 <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            <li class="navs-item">
              <a class="navs-links active" href="<?php echo base_url();?>parents/class_routine/"><i class="os-icon picons-thin-icon-thin-0024_calendar_month_day_planner_events"></i><span><?php echo get_phrase('rotina de classe');?></span></a>
            </li>
            <li class="navs-item">
              <a class="navs-links" href="<?php echo base_url();?>parents/exam_routine/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('rotina de exame');?></span></a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="os-tabs-w">
      ...
      <div class="tab-pane <?php if($active == 1) echo 'active';?>" id="<?php echo $row2['username'];?>">
            ...
            <div class="row m-b">
              ...
              <p><?php echo get_phrase('rotina de classe');?></p>
              </div>
            </div>
            ...
            ?>
              ...
              <?php endfor;?>  
                  ...
                  <button class="btn btn-rounded btn-success pull-right" onclick="printDiv('print_area<?php echo $row2['student_id'];?>')" ><?php echo get_phrase('imprimir');?></button><br><br><br>
                </div>
        </div>  
        <?php endforeach;?>
      </div>
