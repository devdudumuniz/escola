	...
	<div class="os-tabs-w">
			...
			<div class="col-sm-12">	
				<?php 
					...
					<div class="pipeline white lined-secondary">
		  				<div class="pipeline-header">
							<h5 class="pipeline-name"><?php echo get_phrase('Estudante');?></h5>
		  				</div>
		  						...
		  						<div class="pi-body bglogo">
									...
									<div class="pi-info">
			  							...
			  							<div class="pi-sub">
        									...
        									<?php echo get_phrase('seção');?>: <?php echo $this->db->get_where('section' , array('section_id' => $row['section_id']))->row()->name; ?>
			  							</div>
									</div>
		  						</div>
						</div>
				...
				<div class="col-sm-12">
					<div class="element-box lined-primary shadow">
    					<h5 class="form-header"><?php echo get_phrase('marcas');?><br>
            ...
            <td><a class="btn btn-rounded btn-sm btn-primary" style="color:white" href="<?php echo base_url();?>parents/subject_marks/<?php echo $data;?>/<?php echo $row2['exam_id'];?>/"><?php echo get_phrase('view_all');?></a></td>
      						 ...
      						 <div class="form-buttons-w text-right">
                                <a target="_blank" href="<?php echo base_url();?>parents/marks_print_view/<?php echo base64_encode($row1['student_id'].'-'. $row2['exam_id']);?>/"><button class="btn btn-rounded btn-success" type="submit"><i class="picons-thin-icon-thin-0333_printer"></i>  <?php echo get_phrase('imprimir');?></button></a>
                            </div>
    					</div>
  					</div>
				</div>	
