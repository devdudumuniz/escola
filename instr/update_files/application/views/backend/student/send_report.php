		...
		<div class="tab-pane active" id="reports">
			...
			?>
					...
					<?php if($row['priority'] == 'alta'):?>
						<a class="btn nc btn-rounded btn-sm btn-danger" style="color:white"><?php echo get_phrase('alto');?></a>
					<?php endif;?>
					...
					<?php if($row['priority'] == 'baja'):?>
						<a class="btn nc btn-rounded btn-sm btn-secondary" style="color:white"><?php echo get_phrase('baixo');?></a>
						<?php endif;?>
					</td>
					<td>
					<?php if($row['status'] == 0):?>
						<a class="btn nc btn-rounded btn-sm btn-danger" style="color:white" href="#"><?php echo get_phrase('pendente');?></a>
					<?php endif;?>
					<?php if($row['status'] == 1):?>
					...
					<td class="row-actions">
						<a class="btn btn-rounded btn-sm btn-primary" style="color:white" href="<?php echo base_url();?>student/view_report/<?php echo $row['report_code'];?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo get_phrase('visualizar');?></</a>
					</td>	
                        </tr>
                        <?php endforeach;?>
                      </tbody>
