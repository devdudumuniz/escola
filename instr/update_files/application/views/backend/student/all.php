  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
      										    ...
      										    <li><a href="<?php echo base_url();?>student/files/"><i class="picons-thin-icon-thin-0177_puzzle_module_connect"></i><span><?php echo get_phrase('início');?></span></a></li>
        										<li class="active"><a href="<?php echo base_url();?>student/all/"><i class="picons-thin-icon-thin-0130_structure_map_files"></i><span><?php echo get_phrase('todos');?></span></a></li>
        										<li><a href="<?php echo base_url();?>student/recent/"><i class="picons-thin-icon-thin-0117_folder_documents_revert_history"></i><span><?php echo get_phrase('recentes');?></span></a></li>
        										<li><a href="<?php echo base_url();?>student/folders/"><i class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('seus_arquivos');?></span></a></li>
      										</ul>
    									</div>
    									<div class="ae-content-w">
            											...
            											<div class="message-head">
              												<div class="user-w with-status status-green">
                												<div class="user-name">
                  													...
                  													<div class="user-role"><?php $this->db->where('user_type', 'student'); $this->db->where('user_id', $this->session->userdata('login_user_id')); echo $this->db->count_all_results('file');?> <?php echo get_phrase('arquivos');?>.</div>
                												</div>
              												</div>
            											</div>
                                            ...
                                            ?>
						                                            ...
						                                            <div class="notification-event">
                                                                        ...
                                                                        <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>student/files/delete/<?php echo $file['file_id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="font-size:15px;"></i></a>
						                                            </div>
					                                           </li>
					                                           <?php endforeach;?>
				                                            </ul>
