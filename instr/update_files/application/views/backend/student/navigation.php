  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>student/message/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('mensagens');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/teachers/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('professores');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/subject/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('acadêmico');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/my_marks/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('marcas');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/class_routine/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('rotina de classe');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/attendance_report/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('atendimento');?>">
            <div class="left-menu-icon">
         ...
         <li>
          <a href="<?php echo base_url();?>student/library/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('biblioteca');?>">
            <div class="left-menu-icon">
         ...
         <li>
          <a href="<?php echo base_url();?>student/noticeboard/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('novidades');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/request/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('permissões');?>">
            <div class="left-menu-icon">
        ...
        <?php endif;?>
        <li>
          <a href="<?php echo base_url();?>student/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('calendário');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/files/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('arquivos');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>student/invoice/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('pagamentos');?>">
            <div class="left-menu-icon">
      ...
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>student/request/">
            ...
            <span class="left-menu-title"><?php echo get_phrase('permissões');?></span>
          </a>
        </li>
        <?php if($this->db->get_where('settings', array('type' => 'students_reports'))->row()->description == 1):?>
        <li>
        ...
        <li>
          <a href="<?php echo base_url();?>student/files/">
            <div class="left-menu-icon">
              <i class="picons-thin-icon-thin-0125_cloud_sync"></i>
              <span class="left-menu-title"><?php echo get_phrase('arquivos');?></span>
            </div>
          </a>
        </li>
        <li>
