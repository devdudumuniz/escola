				        ...
				        <ul class="notification-list">
					        ...
					        <li>
						        ...
						        <div class="notification-event">
							        ...
							        <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>student/notification/delete/<?php echo $notify['id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
						        </div>
					        </li>
					        <?php endforeach;?>
				        </ul>
