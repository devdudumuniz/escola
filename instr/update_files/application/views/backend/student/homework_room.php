		...
		<div class="pipeline white lined-primary shadow">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big">
				<?php echo get_phrase('arquivo');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url() . 'uploads/homework/' . $row['file_name']; ?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
			</div>
			<?php endif;?>
			...
			<?php echo form_open(base_url() . 'student/delivery/file/'.$homework_code , array('enctype' => 'multipart/form-data'));?>
			  ...
			  <div class="row">
			     <div class="col-sm-12">
                    ...
                    <button type="submit" class="btn btn-success pull-right text-white"><?php echo get_phrase('enviar');?></button>
				 </div>
				</div>
			  <?php echo form_close();?>
			</div>
			...
			<div class="b-t padded-v-big">
			  ...
			  <div class="row">
			     <div class="col-sm-12">
                    <textarea class="form-control" placeholder="<?php echo get_phrase('send_teacher_comment');?>" name="comment" required="" rows="5" style="width:100%"></textarea>
                    <button type="submit" class="btn btn-success pull-right text-white" href="javascript:void(0);"><?php echo get_phrase('enviar');?></button>
				 </div>
				</div>
			</div>
			<?php echo form_close();?>
	...
	<div class="col-sm-4">
		<div class="pipeline white lined-secondary">
		  ...
		  <table class="table table-lightbor table-lightfont">
			  <tr>
				<th>
				  <b><?php echo get_phrase('assunto');?></b>:
				</th>
				<td>
			  ...
			  <tr>
				<th>
				  <b><?php echo get_phrase('classe');?></b>:
				</th>
				<td>
