 ...
 <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            <li class="navs-item">
              <a class="navs-links" href="<?php echo base_url();?>student/class_routine/"><i class="os-icon picons-thin-icon-thin-0024_calendar_month_day_planner_events"></i><span><?php echo get_phrase('rotina de classe');?></span></a>
            </li>
            <li class="navs-item">
              <a class="navs-links active" href="<?php echo base_url();?>student/exam_routine/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('rotina de exame');?></span></a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="content-box">
          <div class="element-wrapper">
			...
			<div class="row m-b">
				...
				<h5><?php echo get_phrase('rotina de exame');?></h5>
