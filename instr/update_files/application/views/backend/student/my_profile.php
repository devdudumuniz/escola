          						...
          						<div class="user-profile">
          							...
          							<div class="ui-block">
										<div class="ui-block-title">		
											<h6 class="title"><?php echo get_phrase('informações_pessoais');?></h6>
										</div>
											...
											<div class="row">
												<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
													<ul class="widget w-personal-info item-block">
														<li>
															<span class="title"><?php echo get_phrase('nome');?>:</span>
														...
														<li>
															<span class="title"><?php echo get_phrase('nome de usuário');?>:</span>
															<span class="text"><?php echo $row['username'];?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('endereço');?>:</span>
															<span class="text"><?php echo $row['address'];?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('seção');?>:</span>
															<?php
														...
														<li>
															<span class="title"><?php echo get_phrase('sala de aula');?>:</span>
												...
												<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
													<ul class="widget w-personal-info item-block">
														...
														<li>
															<span class="title"><?php echo get_phrase('contato');?>:</span>
															<span class="text"><?php echo $row['phone'];?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('aniversário');?>:</span>
															<span class="text"><?php echo $row['birthday'];?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('sexo');?>:</span>
															<span class="text"><?php if($row['sex'] == 'M') echo get_phrase('masculino'); else echo get_phrase('feminino');?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('classe');?>:</span>
															<?php
														...
														<li>
															<span class="title"><?php echo get_phrase('transporte');?>:</span>
                				...
                				<div class="ui-block paddingtel">
                					<div class="ui-block-content">
                						<div class="help-support-block">
											<h4 class="title"><?php echo get_phrase('links_rápidos');?></h4>
											<ul class="help-support-list">
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url();?>student/my_profile/"><?php echo get_phrase('informações_pessoais');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url();?>student/student_update/"><?php echo get_phrase('atualizar informações');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
									...
									<h3 class="text-center"><?php echo get_phrase('suas contas vinculadas');?></h3>
      ...
      <div class="pricing-plan col-sm-6">
        ...
        <div class="plan-body"><br><br>
          <div class="plan-btn-w">
            ...
            <?php else:?>
              <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>student/my_profile/remove_facebook/"><?php echo get_phrase('desvincular');?></a>
            <?php endif;?>
          </div>
        </div>
      </div>
      <div class="pricing-plan col-sm-6">
        ...
        <div class="plan-body"><br><br>
          <div class="plan-btn-w">
            ...
            <?php else:?>
              <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>student/my_profile/remove_google/"><?php echo get_phrase('desvincular');?></a>
            <?php endif;?>
          </div>
        </div>
      </div>
