        ...
        <div class="ui-block-content">
              <?php echo form_open(base_url() . 'accountant/expense/edit/'.$row['payment_id'] , array('enctype' => 'multipart/form-data'));?>
                        <div class="row">
                                ...
                                <div class="form-group label-floating is-select">
                                    ...
                                    <div class="select">
                                        <select name="method" required>
                                            <option value=""><?php echo get_phrase('selecionar');?></option>
                                            <option value="1" <?php if ($row['method'] == 1) echo 'selected';?>><?php echo get_phrase('dinheiro');?></option>
                                            <option value="2" <?php if ($row['method'] == 2) echo 'selected';?>><?php echo get_phrase('cheque');?></option>
                                            <option value="3" <?php if ($row['method'] == 3) echo 'selected';?>><?php echo get_phrase('cartão');?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <button class="btn btn-rounded btn-success btn-lg " type="submit"><?php echo get_phrase('salvar');?></button>
                            </div>
                        </div>
                    <?php echo form_close();?>
                </div>
