  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>accountant/message/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('mensagens');?>">
            <div class="left-menu-icon">
         ...
         <li>
          <a href="<?php echo base_url();?>accountant/news/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('novidades');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>accountant/payments/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('contabilidade');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>accountant/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('calendário');?>">
            <div class="left-menu-icon">
