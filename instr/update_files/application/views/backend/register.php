          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('último_nome');?>" name="last_name" required="" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-12">
               <div class="input-group">
                 ...
                 <input class="form-control" placeholder="<?php echo get_phrase('nome de usuário');?>" required=""  id="username" name="username" type="text">
               </div>
           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('último_nome');?>" name="last_name" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-12">
               <div class="input-group">
                 ...
                 <input class="form-control" placeholder="<?php echo get_phrase('nome de usuário');?>" id="user2" name="username" type="text">
               </div>
    ...
    <?php echo form_open(base_url() . 'register/create_account/parent/' , array('enctype' => 'multipart/form-data'));?>
           <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="input-group">
               ...
               <input class="form-control" placeholder="<?php echo get_phrase('último_nome');?>" required name="last_name" type="text">
               </div>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-12">
               <div class="input-group">
                 ...
                 <input class="form-control" placeholder="<?php echo get_phrase('nome de usuário');?>" id="user5" required="" name="username" type="text">
               </div>
           ...
           <div class="form-group row">
            <div class="col-sm-12">
              ...
              <input class="form-control" placeholder="<?php echo get_phrase('profissão');?>" name="profession" type="text">
              </div>
            </div>
           </div>
           <div class="form-group row">
