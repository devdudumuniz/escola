                						...
                						<div class="help-support-block">
											...
											<ul class="help-support-list">
												<li>
													...
													<a href="<?php echo base_url();?>librarian/my_profile/"><?php echo get_phrase('informações_pessoais');?></a>
												</li>
												<li>
													<svg class="olymp-blog-icon"><use xlink:href="<?php echo base_url();?>style/olapp/svg-icons/sprites/icons.svg#olymp-blog-icon"></use></svg>
													<a href="<?php echo base_url();?>librarian/librarian_update/"><?php echo get_phrase('atualizar informações');?></a>
												</li>
											</ul>
										</div>
									</div>
      ...
      <div class="pricing-plan col-sm-6">
        ...
        <div class="plan-body"><br><br>
          <div class="plan-btn-w">
            ...
            <?php else:?>
              <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>librarian/my_profile/remove_facebook/"><?php echo get_phrase('desvincular');?></a>
            <?php endif;?>
          </div>
        </div>
      </div>
      <div class="pricing-plan col-sm-6">
        ...
        <div class="plan-body"><br><br>
          <div class="plan-btn-w">
            ...
            <?php else:?>
              <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>librarian/my_profile/remove_google/"><?php echo get_phrase('desvincular');?></a>
            <?php endif;?>
          </div>
        </div>
      </div>
