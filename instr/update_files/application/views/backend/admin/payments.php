        ...
        <div class="os-tabs-w menu-shad">
          <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
              <li class="navs-item">
                <a class="navs-links active" href="<?php echo base_url();?>admin/payments/"><i class="os-icon picons-thin-icon-thin-0482_gauge_dashboard_empty"></i><span><?php echo get_phrase('início');?></span></a>
              </li>
              <li class="navs-item">
                <a class="navs-links" href="<?php echo base_url();?>admin/students_payments/"><i class="os-icon picons-thin-icon-thin-0426_money_payment_dollars_coins_cash"></i><span><?php echo get_phrase('pagamentos');?></span></a>
              </li>
              <li class="navs-item">
                <a class="navs-links" href="<?php echo base_url();?>admin/expense/"><i class="os-icon picons-thin-icon-thin-0420_money_cash_coins_payment_dollars"></i><span><?php echo get_phrase('despesa');?></span></a>
              </li>
            </ul>
          </div>
        </div><br>
                      				...
                      				<div class="ae-conte nt-w">                          
                            			<div class="aec-full-m essage-w">
                                			<div class="aec-full -message" style="background-color:#f2f4f8;">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <h2 style="float:left"><?php echo get_phrase('contabilidade');?></h2>
                                                    </div><hr>
					...
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b> <?php echo get_phrase('receita total');?></b></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="friend-item friend-groups">
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b> <?php echo get_phrase('despesa total');?></b></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="friend-item friend-groups">
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b> <?php echo get_phrase('pagamentos pendentes');?></b></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="friend-item friend-groups">
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b> <?php echo get_phrase('pagamentos_concluídos');?></b></div>
							</div> 
						</div>
					</div>
				</div>
    ...
    <div class="row"> 
		<div class="col-sm-6">
			<div class="element-wrapper">
			    <h6 class="element-header"><?php echo get_phrase('receita recente');?></h6>
                        ...
                        <tr>
                            <td>
                              <?php if($row['status'] == 'pending'):?>
                                <span class="status-pill yellow"></span><span><?php echo get_phrase('pendente');?></span>
                              <?php endif;?>
                              <?php if($row['status'] == 'completed'):?>
                                <span class="status-pill green"></span><span><?php echo get_phrase('pago');?></span>
                              <?php endif;?>
                            </td>
		...
		<div class="col-sm-6">
		   <div class="element-wrapper">
              <h6 class="element-header"><?php echo get_phrase('despesas recentes');?></h6>
                <div class="element-box-tp">
                  <div class="table-responsive">
                    <table class="table table-padded">
                      <thead>
