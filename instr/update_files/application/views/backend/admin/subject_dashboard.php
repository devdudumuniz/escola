                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        ...
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url(); ?>admin/homework/delete/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/<?php echo $data;?>/"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>                
                  </div>                
                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        ...
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/manage_exams/delete/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/<?php echo $data;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>
                  </div>                
                ...
                <article class="hentry post thumb-full-width">
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/study_material/delete/<?php echo $this->db->get_where('document', array('document_id' => $wall['homework_id']))->row()->document_id;?>/<?php echo $data;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>                
                  </div>                
                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        ...
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url(); ?>admin/forum/delete/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/<?php echo $data;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>
                  </div>                
