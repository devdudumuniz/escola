                            ...
                            <div class="form-group label-floating is-select">
                                          ...
                                          <div class="select">
                                              <select name="gender" required="">
                                                  ...
                                                  <option value="M" <?php if($row['sex'] == 'M') echo "selected";?>><?php echo get_phrase('masculino');?></option>
                                                  <option value="F" <?php if($row['sex'] == 'F') echo "selected";?>><?php echo get_phrase('feminino');?></option>
                                              </select>
                                          </div>
                                      </div>  
                                    </div> 
