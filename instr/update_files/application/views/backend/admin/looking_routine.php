      ...
      <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            <li class="navs-item">
              <a class="navs-links" href="<?php echo base_url();?>admin/class_routine_view/"><i class="os-icon picons-thin-icon-thin-0024_calendar_month_day_planner_events"></i><span><?php echo get_phrase('rotina de classe');?></span></a>
            </li>
            <li class="navs-item">
            ...
            <li class="navs-item">
              <a class="navs-links active" href="<?php echo base_url();?>admin/looking_routine/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('rotina de exame');?></span></a>
            </li>
          </ul>     
        </div>
      </div>
      <div class="content-box">
        <div class="row">
          ...
          <div class="col col-lg-3 col-md-3 col-sm-12 col-12">
            <div class="text-">
              <button class="btn btn-rounded btn-success btn-upper" data-target="#addExamRoutine" data-toggle="modal" type="button">+ <?php echo get_phrase('add_rotina');?></button>
            </div>
          </div>
        </div>               
          ...
          <div class="os-tabs-w">
            <div class="os-tabs-controls">
              ...
              <?php $query = $this->db->get_where('section' , array('class_id' => $id)); 
                ...
                <li class="navs-item">
                  <a class="navs-link <?php if($rows['name'] == 'A') echo 'active';?>" data-toggle="tab" href="#<?php echo $rows['name'];?>"><?php echo get_phrase('seção');?> <?php echo $rows['name'];?></a>
                </li>
                <?php endforeach;?>
                <?php endif;?>
              </ul>
              ...
              <div class="element-box table-responsive lined-primary shadow" id="print_area<?php echo $row['section_id'];?>">
                <div class="row m-b">
                  ...
                  <div style="padding-left:20px;display:inline-block;">
                    ...
                    <p><?php echo $this->db->get_where('class', array('class_id' => $id))->row()->name;?><br><?php echo get_phrase('seção');?> <?php echo $this->db->get_where('section', array('section_id' => $row['section_id']))->row()->name;?></p>
                  </div>
                </div>
        ...
        <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
          ...
          <div class="pi-controls" style="text-align:right">
            <div class="pi-settings os-dropdown-trigger">
              ...
              <ul>
                <li>
                <a href="#!" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_e_routine/<?php echo $row2['horario_id'];?>');"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo get_phrase('editar');?></span></a>
                </li>
                <li>
                <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/exam_routine/delete/<?php echo $row2['horario_id'];?>"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('excluir');?></span></a>
                </li>
              </ul>
              </div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="ui-block-title" style="background-color:#00579c">
          <h6 class="title" style="color:white"><?php echo get_phrase('add_rotina');?></h6>
        </div>
        <div class="ui-block-content">
          <?php echo form_open(base_url() . 'admin/exam_routine/create' , array('target'=>'_top'));?>
              ...
              <input type='text' class="datepicker-here" data-position="bottom left" data-language='en' name="datetimepicker" data-multiple-dates-separator="/"/>
                    ...
                    <div class="form-group label-floating is-select">
                            ...
                            <div class="select">
                                <select name="day" required="">
                                    ...
                                    <option value="Tuesday"><?php echo get_phrase ('terça-feira');?></option>
                                    ...
                                    <?php if($days == 1):?>
                                      <option value="Saturday"><?php echo get_phrase('sábado');?></option>
                                  <?php endif;?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="form-group label-floating is-select">
                            <label class="control-label" required=""><?php echo get_phrase('tempo');?></label>
                            <div class="select">
                    ...
                    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="form-group label-floating is-select">
                            <label class="control-label" required=""><?php echo get_phrase ('hora');?></label>
                            <div class="select">
                    ...
                    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="form-group label-floating is-select">
                            <label class="control-label" required=""><?php echo get_phrase('minutos');?></label>
                            <div class="select">
              ...
              <div class="form-buttons-w text-right">
                <center><button class="btn btn-rounded btn-success btn-lg" type="submit"><?php echo get_phrase('salvar');?></button></center>
              </div>
            <?php echo form_close();?>        
        </div>
      </div>
