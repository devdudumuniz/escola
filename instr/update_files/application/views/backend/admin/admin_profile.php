                						...
                						<div class="help-support-block">
											...
											<ul class="help-support-list">
												<li>
													...
													<a href="<?php echo base_url();?>admin/admin_profile/<?php echo $admin_id;?>/"><?php echo get_phrase('informações_pessoais');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url();?>admin/admin_update/<?php echo $admin_id;?>/"><?php echo get_phrase('atualizar informações');?></a>
												</li>
											</ul>
										</div>
									</div>
