                    ...
                    <div class="edu-wall-content ng-scope" id="new_post">
                      <div class="tab-pane active show">
                        ...
                        <div class="add-options-message btm-post edupostfoot edu-wall-actions" style="padding:10px 5px;">
                          <a href="javascript:void(0);" class="options-message" onclick="post()" data-toggle="tooltip" data-placement="top"   data-original-title="<?php echo get_phrase('notícia');?>">
                            <i class="os-icon picons-thin-icon-thin-0032_flag"></i>
                          </a>
                          <a href="javascript:void(0);" class="options-message" onclick="poll()" data-toggle="tooltip" data-placement="top"   data-original-title="<?php echo get_phrase('Pesquisas');?>">
                  ...
                  <div class="today-events calendar ">
                    ...
                    <div class="list">
                      <div class="control-block-button">
                        <a href="<?php echo base_url();?>admin/calendar/" class="btn btn-control bg-breez" style="justify-content:center;background-color:#22b9ff;display:flex;">
