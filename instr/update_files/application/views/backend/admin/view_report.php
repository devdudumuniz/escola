	...
	<div class="col-sm-8">
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="pipeline-header-numbers">
			  ...
			  <div class="col-3 text-right">
			  	<?php if($row['priority'] == 'alta'):?>
					<a class="btn nc btn-rounded btn-sm btn-danger text-left" style="color:white"><?php echo get_phrase('alto');?></a></td>
				<?php endif;?>
				<?php if($row['priority'] == 'media'):?>
					<a class="btn nc btn-rounded btn-sm btn-warning text-left" style="color:white"><?php echo get_phrase('médio');?></a></td>
				<?php endif;?>
				<?php if($row['priority'] == 'baja'):?>
					<a class="btn nc btn-rounded btn-sm btn-info text-left" style="color:white"><?php echo get_phrase('baixo');?></a></td>
				<?php endif;?>
			  </div>
			</div>
		  </div>
			...
			<?php echo get_phrase('arquivo');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url();?>uploads/reportes_alumnos/<?php echo $row['file'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('download');?></a></td>
	...
	<div class="col-sm-4">
		<div class="ui-block paddingtel lined-danger">
	        <div class="ui-block-title">
			    <h6 class="title"><?php echo get_phrase('professor');?></h6>
			</div>
                            <div class="ui-block-content">
                                <div class="widget w-about" style="text-align:center">
                                    ...
                                    <h4><?php echo $this->crud_model->get_name('teacher', $row['teacher_id']);?><br> <small><?php echo get_phrase('contato');?>:  <?php echo $this->db->get_where('teacher', array('teacher_id' => $row['teacher_id']))->row()->phone;?>.</small></h4>
                                    <h5><a class="badge badge-primary" href="javascript:void(0);"><?php echo get_phrase('professor');?></a></h5>
                                   <br>
                                </div>
                            </div>
                        </div>
		...
		<div class="ui-block paddingtel lined-danger">
	        <div class="ui-block-title">
			    <h6 class="title"><?php echo get_phrase('Estudante');?></h6>
			</div>
                            <div class="ui-block-content">
                                <div class="widget w-about" style="text-align:center">
                                    ...
                                    <h5><a class="badge badge-info" href="javascript:void(0);"><?php echo get_phrase('seção');?> <?php echo $this->db->get_where('section', array('section_id' => $cl_id))->row()->name;?></a></h5>
                                   <br>
                                </div>
                            </div>
                        </div>
