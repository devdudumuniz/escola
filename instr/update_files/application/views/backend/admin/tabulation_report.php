    ...
    <div class="conty">
		...
		<div class="os-tabs-controls">
			<ul class="navs navs-tabs">
				...
				<li class="navs-item">
				  <a class="navs-links <?php if($page_name == 'tabulation_report') echo "ativo";?>" href="<?php echo base_url();?>admin/tabulation_report/"><i class="picons-thin-icon-thin-0070_paper_role"></i> <span><?php echo get_phrase('folha de classificação');?></span></a>
				</li>
				<li class="navs-item">
  	...
  	<div class="content-i">
	    <div class="content-box">
	  		<h5 class="form-header"><?php echo get_phrase('folha de classificação');?></h5><hr>
