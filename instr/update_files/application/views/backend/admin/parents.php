												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('pais');?></a>
                                                            ...
                                                            <div class="card-box widget-user ui-block list">
                                                                <div class="more" style="float:right;">
                                                                        ...
                                                                        <ul class="more-dropdown">
                                                                            <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_parent/<?php echo $row['parent_id'];?>');"><?php echo get_phrase('editar');?></a></li>
                                                                            <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/parents/delete/<?php echo $row['parent_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                                                        </ul>
                                                                    </div>
                                                                <div>
                    ...
                    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
              		...
              		<div class="col col-lg-12 col-md-12 col-sm-12 col-12">          
                		<div class="form-group label-floating is-empty">
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <button class="btn btn-rounded btn-success btn-lg" id="sub_parent" type="submit"><?php echo get_phrase('salvar');?></button>
                            </div>
                        </div>
                    <?php echo form_close();?>
