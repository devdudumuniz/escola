                  ...
                  <div class="friend-item-content">
                    <div class="friend-avatar">
                      ...
                      <div class="author-content">
                        ...
                        <div class="country"><?php echo get_phrase('disponível para todos os usuários');?></div>
                      </div>
                    </div>
                    <div class="control-block-button">
                            ...
                            <div class="select">
                                 <select required name="type" required="">
							        <option value=""><?php echo get_phrase('selecionar');?></option>
                            		 ...
                            		 <option value="accountant"><?php echo get_phrase('contadores');?></option>
                            		 <option value="librarian"><?php echo get_phrase('bibliotecários');?></option>
						        </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group label-floating is-select">
                ...
                <div class="select">
                    <select required name="receiver" id="type" required="">
						<option value=""><?php echo get_phrase('selecionar');?></option>
                        <option value="admin"><?php echo get_phrase('admins');?></option>
                        <option value="teacher"><?php echo get_phrase('professor');?></option>
                        <option value="student"><?php echo get_phrase('alunos');?></option>
                        <option value="parent"><?php echo get_phrase('pais');?></option>
                        <option value="accountant"><?php echo get_phrase('contadores');?></option>
                        <option value="librarian"><?php echo get_phrase('bibliotecários');?></option>
