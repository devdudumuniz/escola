											...
											<div class="row">
												<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
													<ul class="widget w-personal-info item-block">
														...
														<li>
															<span class="title"><?php echo get_phrase('alergias');?>:</span>
															<span class="text"><?php echo $row['allergies'];?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('médico que acompanha');?>:</span>
												...
												<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
													<ul class="widget w-personal-info item-block">
														...
														<li>
															<span class="title"><?php echo get_phrase('condições ou doenças');?>:</span>
															<span class="text"><?php echo $row['diseases'];?></span>
														</li>
														<li>
															<span class="title"><?php echo get_phrase('número do médico');?>:</span>
                						...
                						<div class="help-support-block">
											...
											<ul class="help-support-list">
												<li>
													...
													<a href="<?php echo base_url();?>admin/student_portal/<?php echo $student_id;?>/"><?php echo get_phrase('informações_pessoais');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url();?>admin/student_update/<?php echo $student_id;?>/"><?php echo get_phrase('atualizar informações');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
