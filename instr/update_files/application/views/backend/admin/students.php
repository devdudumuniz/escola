												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('alunos');?> <small>(<?php if($class_id > 0) echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?>)</small></a>
			                                                ...
			                                                <div class="row">
			                                                    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                		                                            <div class="form-group label-floating" style="background-color: #fff;">
                  			                                            <label class="control-label"><?php echo get_phrase('pesquisar');?></label>
																	...
																	<div class="os-tabs-controls">
		  																<ul class="navs navs-tabs upper" style="padding-left:20px; padding-top:20px">
																			<li class="navs-item" style="display:inline;">
			  																	<a class="navs-link active" style="color:#000;" data-toggle="tab" href="#all"><?php echo get_phrase('todos');?></a>
																			</li>
																			...
																			<li class="navs-item">
			  																	<a class="navs-link" style="color:#000;" data-toggle="tab" href="#tab<?php echo $rows['section_id'];?>"><?php echo get_phrase('seção');?> <?php echo $rows['name'];?></a>
																			</li>
																			<?php endforeach;?>
																			<?php endif;?>
		  																</ul>
                        													...
                        													<div class="card-box widget-user ui-block list">
                            													<div class="more" style="float:right;">
                                    												...
                                    												<ul class="more-dropdown">
                                        												<li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_estudiante/<?php echo $row['student_id'];?>');"><?php echo get_phrase('editar');?></a></li>
                                        												<li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/delete_student/<?php echo $row['student_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                    												</ul>
                                												</div>
                            												<div>
                														...
                														<div class="col-xl-4 col-md-6">
                        													<div class="card-box widget-user ui-block list">
                            													<div class="more" style="float:right;">
                                    												<i class="icon-options"></i>    
                                    												<ul class="more-dropdown">
                                        												<li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_estudiante/<?php echo $row2['student_id'];?>');"><?php echo get_phrase('editar');?></a></li>
                                        												<li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/delete_student/<?php echo $row2['student_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                    												</ul>
                                												</div>
                            												<div>
...
<div class="modal fade" id="student_export" tabindex="-1" role="dialog" aria-labelledby="student_export" aria-hidden="true" style="margin-top: 150px;">
  <div class="modal-dialog window-popup edit-widget edit-widget-twitter" role="document">
    <div class="modal-content">
      ...
      <button class="btn btn-rounded btn-purple  btn-icon-left" type="submit"><i class="picons-thin-icon-thin-0129_download"></i> <?php echo get_phrase('exportar');?></button></center>
      <?php echo form_close();?>
    </div>
    </div>
  </div>
        ...
        <?php echo form_open(base_url() . 'admin/student/bulk' , array('enctype' => 'multipart/form-data'));?>
          ...
          <div class="modal-body">
            ...
            <div class="form-group with-button">
              <a href="<?php echo base_url();?>uploads/templates/Students.xlsx"><input class="form-control " readonly value="<?php echo get_phrase('baixar modelo');?>" type="text" style="cursor: default; color:#000: font-weight:bold">
