                                ...
                                <div class="form-group label-floating is-select">
                                    ...
                                    <div class="select">
                                        <select name="gender" id="slct">
                                            ...
                                            <option value="M" <?php if($row['gender'] == 'M') echo 'selected';?>><?php echo get_phrase('masculino');?></option>
                                            <option value="F" <?php if($row['gender'] == 'F') echo 'selected';?>><?php echo get_phrase('feminino');?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
