        ...
        <div class="chat-content text-center">
                ...
                ?>
                    <div class="col-md-12" style="margin-top: 10px;">
                        <table  class="table table-bordered table-striped">
                            ...
                            <thead>
                                <tr>
                                    <th><input type="checkbox" id="<?php echo $user_array[$i]; ?>" onchange="checkAllBoxes(this)">&nbsp;<?php echo get_phrase('selecionar tudo');?></th>
                                    <th></th>
                                    <th></th>
                                </tr>
                            </thead>
                            <thead>
                                <tr>
                                    <th style="background-color:#99bf2d; color: #fff;"><?php echo get_phrase('selecionar');?></th>
                                    <th style="background-color:#99bf2d; color: #fff;"><?php echo get_phrase('user');?></th>
                                    <th style="background-color:#99bf2d; color: #fff;"><?php echo get_phrase('nome');?></th>
                                </tr>
                            </thead>
                ...
                <?php endfor; ?>
                    <div class="pull-right">
                        <button type="submit" name="submit" class="btn btn-purple btn-rounded"><?php echo get_phrase('atualizar');?></button>
                    </div>
                <br><br>
            </form>
        </div>
