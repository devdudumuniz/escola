            ...
            <tbody>
              <?php foreach ($students_array as $row):?>
                    <tr>
                      ...
                      <td><?php  if ($query->num_rows() > 0){?><a href="<?php echo base_url();?>admin/online_exam_result/<?php echo $online_exam_id;?>/<?php echo $row['student_id'];?>/" class="btn btn-success btn-sm btn-rounded"><?php echo get_phrase('view_results');?></a><?php } else echo get_phrase('sem_ações');?></td>
                    </tr>
            <?php endforeach; ?>
                </tbody>
            </table>
  ...
  <div class="col-sm-4">
    <div class="pipeline white lined-secondary">
      ...
      <table class="table table-lightbor table-lightfont">
        ...
        <tr>
        <th>
          <?php echo get_phrase('porcentagem necessária');?>:
        </th>
        <td>
