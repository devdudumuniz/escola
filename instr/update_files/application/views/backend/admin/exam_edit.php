      ...
      <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            ...
            <li class="navs-item">
              <a class="navs-links active" href="<?php echo base_url();?>admin/exam_edit/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo get_phrase('editar');?></span></a>
            </li>
          </ul>
        </div>
      </div>
...
<?php echo form_open(base_url() . 'admin/online_exams/edit/', array('enctype' => 'multipart/form-data')); ?>
      <div class="row">
       <div class="col-sm-4">
        ...
        <label class="col-form-label" for=""><?php echo get_phrase('título');?></label>
        ...
        <div class="col-sm-4">
        <div class="form-group">
        <label class="col-form-label" for=""><?php echo get_phrase('porcentagem necessária');?></label>
          <div class="input-group">
      ...
      <div class="col-sm-12">
        <div class="form-group">
            <label class="col-form-label" for=""><?php echo get_phrase('descrição');?></label>
        ...
        <div class="form-group">
          <div class="col-sm-12" style="text-align: center;">
            <button type="submit" class="btn btn-success btn-rounded"><?php echo get_phrase('atualizar');?></button>
          </div>
        </div>
        </div>
    <?php echo form_close();?>
