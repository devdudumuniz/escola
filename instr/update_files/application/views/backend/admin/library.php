                ...
                <div class="element-box-tp">
                  <div class="table-responsive">
				    ...
				    <td class="row-actions">
					    ...
					    <a class="danger" onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/library/delete/<?php echo $row['book_id'];?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
				    </td>
			    </tr>
			    <?php endforeach;?>
                    </tbody>
