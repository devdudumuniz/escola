<div class="col-md-2">
	...
	<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('seção');?></label>
...
<div class="col-md-3">
	<div class="form-group">
	<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('assunto');?></label>
...
<div class="col-md-2" style="margin-top: 20px;">
	<center>
		<button type="submit" class="btn btn-info"><?php echo get_phrase('visualizar');?></button>
	</center>
</div>
