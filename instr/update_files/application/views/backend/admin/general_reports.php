	...
	<div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
			<ul class="navs navs-tabs">
				<li class="navs-item">
				  <a class="navs-links <?php if($page_name == 'general_reports') echo "ativo";?>" href="<?php echo base_url();?>admin/general_reports/"><i class="picons-thin-icon-thin-0658_cup_place_winner_award_prize_achievement"></i> <span><?php echo get_phrase('classes');?></span></a>
				</li>
				<li class="navs-item">
  	...
  	<div class="content-i">
	    <div class="content-box">
	  	<h5 class="form-header"><?php echo get_phrase('relatório da turma');?></h5>
	  		<div class="row">
				<div class="content-i">
					<div class="content-box">
					...
					<?php if($class_id != "" && $section_id != ""):?>
						<div class="row">
							<div class="text-center col-sm-6"><br>
								...
								<p><b><?php echo get_phrase('professor');?>:</b> <?php echo $this->crud_model->get_name('teacher', $this->db->get_where('class', array('class_id' => $class_id))->row()->teacher_id);?><br><b><?php $this->db->where('class_id', $class_id); $this->db->where('section_id', $section_id); echo $this->db->count_all_results('enroll');?></b> <?php echo get_phrase('alunos');?>  |  <b><?php $this->db->where('class_id', $class_id); echo $this->db->count_all_results('subject');?></b> <?php echo get_phrase('assuntos');?>.<br><b><?php echo get_phrase('ano corrente');?>:</b> <?php echo $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;?></p>
							</div>
							<div class="col-sm-6 text-center">
								<div class="up-main-info">
    								<div class="user-avatar-w"> 
          							...
          							<h6 class="up-sub-header"><div class="value badge badge-pill badge-success"><?php echo get_phrase('professor');?></div></h6>
        						</div>
							</div><hr>
							<div class="col-sm-6">
							...
							<div class="col-sm-6">
								<div class="element-box">
      								<div class="form-header">
      									<h6><?php echo get_phrase('assuntos');?></h6>
      								</div>
      								<div class="table-responsive">
      									<table width="100%" class="table table-lightborder table-lightfont">
      										<thead>
      											<tr>
      												<th style="text-align: left;"><?php echo get_phrase('assunto');?></th>
      												<th style="text-align: center;"><?php echo get_phrase('professor');?></th>
      											</tr>
      										</thead>
      										<tbody>
      											<?php 
