                    ...
                    <div class="select">
                        <select name="reciever" id="slct" required="">
                            ...
                            <?php endforeach; ?>
                             ...
                             <optgroup label="<?php echo get_phrase('professores');?>">
                            <?php
                            ...
                            <optgroup label="<?php echo get_phrase('pais');?>">
                            <?php
                            ...
                            <optgroup label="<?php echo get_phrase('alunos');?>">
                            <?php
                            ...
                            <optgroup label="<?php echo get_phrase('bibliotecários');?>">
                            <?php
                            ...
                            <optgroup label="<?php echo get_phrase('contadores');?>">
                            <?php
