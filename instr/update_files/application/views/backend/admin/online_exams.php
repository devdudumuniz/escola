                        ...
                        <thead>
                          ...
                          <tr>
                            ...
                            <td class="bolder">
                                ...
                                <?php endif; ?>
                                <a class="btn btn-danger btn-sm" onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/manage_exams/delete/<?php echo $row['online_exam_id'];?>/<?php echo $data;?>/"><?php echo get_phrase('excluir');?></a>
                            </td>
                          </tr>
                        <?php endforeach;?>
                      </tbody>
