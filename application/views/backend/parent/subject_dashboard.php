                ...
                <article class="hentry post thumb-full-width">                
                  ...
                  <div class="edu-posts cta-with-media morado">
                    <div class="cta-content">
                      ...
                      <a href="<?php echo base_url();?>parents/online_exams/<?php echo $data;?>/"><button class="btn btn-rounded btn-posts green"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('view_exam');?></button></a>
                    </div>
                  </div>              
                  <div class="control-block-button post-control-button">                
                          ...
                          foreach($Students as $row2):?>
                            <li class="inline-items">
                              ...
                              <div class="notification-event">
                                ...
                                <span class="chat-message-item">ID da lista: <?php echo $this->db->get_where('enroll' , array('student_id' => $row2['student_id']))->row()->roll; ?></span>
                              </div>
                            </li>
                          <?php endforeach;?>
                        </ul>
