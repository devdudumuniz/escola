      ...
      <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            <li class="navs-item">
              <a class="navs-links" href="<?php echo base_url();?>admin/system_settings/"><i class="os-icon picons-thin-icon-thin-0050_settings_panel_equalizer_preferences"></i><span><?php echo get_phrase('configurações do sistema');?></span></a>
            </li>
            <li class="navs-item">
            ...
            <li class="navs-item">
              <a class="navs-links active" href="<?php echo base_url();?>admin/translate/"><i class="os-icon picons-thin-icon-thin-0307_chat_discussion_yes_no_pro_contra_conversation"></i><span><?php echo get_phrase('traduzir');?></span></a>
            </li>
            <li class="navs-item">
                ...
                <input type="hidden" name="total_phrase" value="<?php echo $this->db->count_all_results('language');?>">
                  <div class="col-sm-12">
                    <div class="form-buttons-w text-right">
                      <button class="btn btn-rounded btn-primary" type="submit"> <?php echo get_phrase('atualizar');?> </button>
                    </div>
                </div>
              <?php echo form_close(); ?>
            </div>
                    ...
                    <div class="users-list-w">
                      ...
                      ?>
                        <div class="user-w">
                          ...
                          <a class="btn btn-rounded  btn-primary" href="<?php echo base_url();?>admin/translate/update/<?php echo $data[$i];?>"><i class="picons-thin-icon-thin-0307_chat_discussion_yes_no_pro_contra_conversation"></i> <?php echo get_phrase('atualizar');?></a>
                        </div>
                      <?php endfor;?>
                    </div>
                  </div>
...
<div class="modal fade" id="addlang" tabindex="-1" role="dialog" aria-labelledby="addlang" aria-hidden="true" style="margin-top: 150px;">
  <div class="modal-dialog window-popup edit-widget edit-widget-twitter" role="document">
    <div class="modal-content">
      ...
      <button class="btn btn-rounded btn-purple  btn-icon-left" type="submit"><?php echo get_phrase('salvar');?></button></center>
      <?php echo form_close();?>
    </div>
    </div>
  </div>
