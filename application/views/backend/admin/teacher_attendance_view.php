  ...
  <div class="header-spacer"></div>
       <div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
		  <ul class="navs navs-tabs upper">
			...
			<li class="navs-item">
			  <a class="navs-links active" href="<?php echo base_url();?>admin/teacher_attendance/"><i class="os-icon picons-thin-icon-thin-0704_users_profile_group_couple_man_woman"></i><span><?php echo get_phrase('frequência do professor');?></span></a>
			</li>
			<li class="navs-item">
    ...
    <?php echo form_open(base_url() . 'admin/attendance_teacher/', array('class' => 'form m-b'));?>
      <div class="row">
        ...
        <div class="col-sm-2">
          <div class="form-group"> <button class="btn btn-rounded btn-primary btn-upper" style="margin-top:20px" type="submit"><span><?php echo get_phrase('visualizar');?></span></button></div>
        </div>
      </div>
    <?php echo form_close();?>
    <div class="ui-block">
      ...
      <?php echo form_open(base_url() . 'admin/attendance_update2/' . $timestamp); ?>
        <table class="table table-lightborder">
          <thead>
            <tr class="bg-primary">
              <th class="text-white"><?php echo get_phrase('professor');?></th>
        ...
        <div class="form-buttons-w">
          <button class="btn btn-success btn-rounded" type="submit"> <?php echo get_phrase('atualizar');?></button>
        </div>
        <?php echo form_close();?>
      </div>
                  </div>
