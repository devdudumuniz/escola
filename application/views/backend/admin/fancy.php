    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options">
            <?php 
                ...
                foreach($fancy_subjects as $fancy_row2):
            ?>
            <a href="<?php echo base_url();?>admin/cursos/<?php echo base64_encode($fancy_row2['class_id']);?>/"><div class="fancy-selector-option <?php if($fc_info == $fancy_row2['class_id']) echo "ativo";?>">
              <div class="fs-main-info">
                <div class="fs-name">
    ...
    <div class="header-content-wrapper" <?php if($page_name != 'cursos'):?> style="padding-left: 85px;" <?php endif;?>>
          <?php echo form_open(base_url() . 'admin/search_query' , array('class' => 'search-bar w-search notification-list friend-requests', 'onsubmit' => 'return validate() role="search"')); ?>
            <div class="form-group with-button">
                <input class="form-control js-user-se arch" placeholder="<?php echo get_phrase('Procurar aluno');?>..." type="text" value="<?php echo base64_decode($search_key);?>" name="search_key" required>
        ...
        <div class="control-block">
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                          ...
                          ?>
                            ...
                            <li class="message-unread">
                                ...
                                <div class="notification-event">
                                    ...
                                    <span class="chat-message-item" style="text-align: justify;"><?php if($rw->sender == $fancy_current_user) echo get_phrase('você').": " .substr($rw->message, 0, 90).'...'; else echo substr($rw->message, 0, 90);?>...</span>
                    ...
                    <a href="<?php echo base_url();?>admin/message/" class="view-all bg-info"><?php echo get_phrase('ver todas as mensagens');?></a>
                </div>
            </div>
            <div class="control-icon more has-items">
                ...
                ?>
                  ...
                  <?php endforeach;?>
                    ...
                    <a href="<?php echo base_url();?>admin/notifications/" class="view-all bg-info"><?php echo get_phrase('ver todas as notificações');?></a>
                </div>
            </div>
                            ...
                            <ul class="account-settings">
                                <li>
                                    <a href="<?php echo base_url();?>admin/my_account/">
                                        ...
                                        <span><?php echo get_phrase('minha conta');?></span>
                                    </a>
                                </li>
                                <li>
                ...
                <div class="mCustomScrollbar" data-mcs-theme="dark">
                    <ul class="account-settings">
                        <li>
                            <a href="<?php echo base_url();?>admin/my_account/">
                                <i class="picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i>
                                <span><?php echo get_phrase('meu perfil');?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>login/logout/">
