										...
										<div class="ui-block-content">
										    <div class="table-responsive">
                                                <table width="100%" class="table table-lightborder table-lightfont">
                                                    <thead>
                                                        <tr>
                                                            <th style="text-align: left;"><?php echo get_phrase('Estudante');?></th>
                                                            <th style="text-align: center;"><?php echo get_phrase('classe');?></th>
                                                            <th style="text-align: center;"><?php echo get_phrase('seção');?></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
