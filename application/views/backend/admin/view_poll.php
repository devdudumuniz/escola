                ...
                <div class="el-legend">
                  ...
                  <div class="legend-value-w">
                    ...
                    <div class="legend-value"><?php echo $array[$i];?> 
					            <span class="gi">- <?php echo $res;?> <?php echo get_phrase('usuários');?>.</span>
                    </div>
                  </div>
                <?php endfor;?>
                </div>
                ...
                <table class="table table-lightborder">
                    <thead>
                        <tr>
                          ...
                          <th class="text-center"><?php echo get_phrase('data');?></th>
                        </tr>
                    </thead>
                    <tbody>
                       <?php 
                      ...
                      <tr>
                        ...
                        <?php if($arrays[0] == "admin"):?>
                          ...
                          <?php if($arrays[0] == "accountant"):?>
                            <a class="btn nc btn-sm btn-rounded btn-info" href="#"><?php echo get_phrase('contador');?></a>
                          <?php endif;?>
