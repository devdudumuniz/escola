                    ...
                    <div class="app-email-i">
                      <div class="ae-side-menu">
                          ...
                          <ul class="ae-main-menu">
                              <li><a href="javascript:void(0);" data-toggle="modal" data-target="#bulkupload"><b style="font-size:20px">+</b><span> <?php echo get_phrase('pasta');?></span></a></li>
                              <li><a href="<?php echo base_url();?>admin/files/"><i class="picons-thin-icon-thin-0177_puzzle_module_connect"></i><span><?php echo get_phrase('início');?></span></a></li>
                            <li><a href="<?php echo base_url();?>admin/all/"><i class="picons-thin-icon-thin-0130_structure_map_files"></i><span><?php echo get_phrase('todos');?></span></a></li>
                            <li><a href="<?php echo base_url();?>admin/recent/"><i class="picons-thin-icon-thin-0117_folder_documents_revert_history"></i><span><?php echo get_phrase('recentes');?></span></a></li>
                            <li class="active"><a href="<?php echo base_url();?>admin/folders/"><i class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('seus_arquivos');?></span></a></li>
                          </ul>
                      </div>
                                    ...
                                    <ul class="widget w-friend-pages-added notification-list friend-requests">
                                      ...
                                      <li class="inline-items">
                                        ...
                                        <div class="notification-event">
                                          ...
                                          <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/folders/delete/<?php echo $row['folder_id'];?>"><i style="font-size:15px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
                                        </div>
                                      ...
                                      <ul class="widget w-friend-pages-added notification-list friend-requests">
                                        ...
                                        <li class="inline-items">
                                         ...
                                         <div class="notification-event">
                                           ...
                                           <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/files/delete/<?php echo $file['file_id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="font-size:15px;"></i></a>
                                         </div>
                                       </li>
                                    <?php endforeach;?>
                                    </ul>
      ...
      <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
        ...
        <?php echo form_open(base_url() . 'admin/files/create_folder' , array('enctype' => 'multipart/form-data'));?>
          ...
          <div class="modal-header">
            <h6 class="title"><?php echo get_phrase('nova_pasta');?></h6>
          </div>
          <div class="modal-body">
            <div class="form-group with-button">
              <input class="form-control" placeholder="<?php echo get_phrase('nome');?>" name="name" type="text" required>
            </div>
            <button type="submit" class="btn btn-rounded btn-purple btn-lg full-width"><?php echo get_phrase('criar');?></button>
          </div>
          <?php echo form_close();?>
        </div>
      </div>
