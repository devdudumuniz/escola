      ...
      <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            ...
            <li class="navs-item">
              <a class="navs-links active" href="<?php echo base_url();?>admin/teacher_routine/"><i class="os-icon picons-thin-icon-thin-0011_reading_glasses"></i><span><?php echo get_phrase('rotina do professor');?></span></a>
            </li>
            <li class="navs-item">
           ...
           <?php if($teacher_id > 0):?>
            <div class="element-wrapper">
              <div class="element-box table-responsive lined-primary shadow" id="print_area">
                <div>
            <center> 
                <h5><?php echo get_phrase('rotina do professor');?></h5>
            ...
            <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
              ...
              <?php
                ...
                <td style="text-align:center"><?php
                        ...
                        ?><br><b><?php echo $this->crud_model->get_subject_name_by_id($row2['subject_id']);?></b><br><small><?php echo $this->db->get get_phrase(_where('class', array('class_id' => $row2['class_id']))->row()->name;?> - <strong><?php echo $this->db->get_where('section', array('section_id' => $row2['section_id']))->row()->name;?></strong></small></td>
          <?php endforeach;?>
            </table>
                    </tr>
                    <?php endfor;?>       
                        ...
                        <button class="btn btn-rounded btn-primary pull-right" onclick="printDiv('print_area')" ><?php echo get_phrase('imprimir');?></button><br><br><br>
                    </div>  
                <?php endif;?>
                </div>      
            </div>
