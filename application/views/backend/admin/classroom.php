												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('salas de aula');?></a>
			                                                        ...
			                                                        <div class="ui-block list">
			                                                            <div class="more" style="float:right; margin-right:15px; ">
                                                                            ...
                                                                            <ul class="more-dropdown" style="z-index:999">
                                                                                <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_classrooms/<?php echo $room['dormitory_id'];?>');"><?php echo get_phrase('alunos');?></a></li>
                                                                                <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_classroom/<?php echo $room['dormitory_id'];?>');"><?php echo get_phrase('editar');?></a></li>
                                                                                <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/classrooms/delete/<?php echo $room['dormitory_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                                                            </ul>
                                                                        </div>
				                                                        <div class="birthday-item inline-items">
                                                                            <div class="circle blue"><?php echo $room['name'][0];?></div>&nbsp;
					                                                           <div class="birthday-author-name">
						                                                           ...
						                                                           <div><b><?php echo get_phrase('alunos');?>:</b> <?php $this->db->where('dormitory_id', $room['dormitory_id']); echo $this->db->count_all_results('student');?>.</div>
					                                                       </div>
				                                                        </div>
			                                                        </div>
		                                                        </div>
