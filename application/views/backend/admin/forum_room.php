              ...
              <div class="col-sm-8">
                <div class="ui-block responsive-flex">
                  <table class="open-topic-table" id="panel">
                    <thead>
                      <tr>
                        <th class="author"><?php echo get_phrase('autor');?></th>
                      ...
                      <tr>
                        ...
                        <td class="posts">
                          ...
                          <?php if($row['file_name'] != ""):?>
                            <?php echo get_phrase('arquivo');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url();?>uploads/forum/<?php echo $row['file_name'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                          <?php endif;?>
                        </td>
                      </tr>
                      <?php
