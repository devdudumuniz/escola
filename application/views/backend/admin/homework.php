                        ...
                        <thead>
                          ...
                          <tr>
                            ...
                            <td class="bolder">
						        ...
						        <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('excluir');?>" class="danger" href="<?php echo base_url(); ?>admin/homework/delete/<?php echo $hm['homework_code']; ?>/<?php echo $data;?>/" onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                            </td>
                          </tr>
                        <?php endforeach;?>
                      </tbody>
	            ...
	            <div class="row">
                    ...
                    <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="custom-control custom-radio">
                            <input  type="radio" name="type" id="2" value="2" class="custom-control-input"> <label for="2" class="custom-control-label"><?php echo get_phrase('arquivos');?></label>
                        </div>
            		</div>
