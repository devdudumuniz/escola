												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('professores');?></a>
                                                            ...
                                                            <div class="card-box widget-user ui-block list">
                                                                <div class="more" style="float:right;">
                                                                        ...
                                                                        <ul class="more-dropdown">
                                                                            <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_teacher/<?php echo $row['teacher_id'];?>');"><?php echo get_phrase('editar');?></a></li>
                                                                            <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/teachers/delete/<?php echo $row['teacher_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                                                        </ul>
                                                                    </div>
                                                                <div>
        	...
        	<?php echo form_open(base_url() . 'admin/teachers/create' , array('enctype' => 'multipart/form-data'));?>
	            <div class="row">
          		...
          		<div class="form-buttons-w text-right">
	             	<center><button class="btn btn-rounded btn-success btn-lg" id="sub_teacher" type="submit"><?php echo get_phrase('salvar');?></button></center>
          		</div>
          	<?php echo form_close();?>        
        </div>
      </div>
