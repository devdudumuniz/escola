    ...
    <div class="conty">
		...
		<div class="os-tabs-controls">
			<ul class="navs navs-tabs">
				...
				<li class="navs-item">
				  <a class="navs-links <?php if($page_name == 'marks_report') echo "ativo";?>" href="<?php echo base_url();?>admin/marks_report/"><i class="picons-thin-icon-thin-0100_to_do_list_reminder_done"></i>  <span><?php echo get_phrase('marcas_finais');?></span></a>
				</li>
				<li class="navs-item">
  			...
  			<div class="content-i">
	    		<div class="content-box">
	  				<h5 class="form-header"><?php echo get_phrase('cartão de estudante');?></h5><hr>
        				...
        				<div class="rcard-w">
          					<div class="infos">
            					<div class="info-1">
              						...
              						<div class="company-address"><?php echo get_phrase('marcas');?></div>
            				...
            				<div class="rcard-table table-responsive">
              					<table class="table">
                					<thead>
                  						<tr>
                    						<th class="text-center"><?php echo get_phrase('assunto');?></th>
                    						<th class="text-center"><?php echo get_phrase('professor');?></th>
                    						<th class="text-center"><?php echo get_phrase('marca');?></th>
