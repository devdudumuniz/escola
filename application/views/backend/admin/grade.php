<div class="content-w">
 ...
 <div class="content-i">
  <div class="content-box">
      ...
      <div style="margin: auto 0;float:right;"><button class="btn btn-success btn-rounded btn-upper" data-target="#new_grade" data-toggle="modal" type="button">+ <?php echo get_phrase('novo');?></button></div><br>
          <div class="element-wrapper">
              <h6 class="element-header"><?php echo get_phrase('níveis de notas');?></h6>
                    ...
                    <table class="table table-padded">
                      <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrase('ponto');?></th>
                            <th><?php echo get_phrase('marcar de');?></th>
                            <th><?php echo get_phrase('marcar para');?></th>
                        ...
                        <tr>
                            ...
                            <td class="row-actions">
                                ...
                                <a style="color:grey" onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/grade/delete/<?php echo $row['grade_id'];?>"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
      ...
      <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
        ...
        <?php echo form_open(base_url() . 'admin/grade/create/');?>
          ...
          <div class="modal-header">
            <h6 class="title"><?php echo get_phrase('novo');?></h6>
          </div>
          <div class="modal-body">
            <div class="form-group with-button">
                <label><?php echo get_phrase('nome');?></label>
              <input class="form-control" name="name"  type="text" required="">
            </div>
            <div class="form-group with-button">
                <label><?php echo get_phrase('ponto');?></label>
              <input class="form-control" name="point"  type="text" required="">
            </div>
            <div class="form-group with-button">
                <label><?php echo get_phrase('marcar de');?></label>
              <input class="form-control" name="from"  type="text" required="">
            </div>
            <div class="form-group with-button">
                <label><?php echo get_phrase('marcar para');?></label>
