                                                            ...
                                                            <div class="card-box widget-user ui-block list">
                                                                <div class="more" style="float:right;">
                                                                        ...
                                                                        <ul class="more-dropdown">
                                                                            <li><a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_admin/<?php echo $row['admin_id'];?>');"><?php echo get_phrase('editar');?></a></li>
                                                                            <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/admins/delete/<?php echo $row['admin_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                                                        </ul>
                                                                    </div>
                                                                <div>
      ...
      <div class="modal-header" style="background-color:#00579c">
        ...
        <div class="ui-block-content">
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group label-floating is-select">
                        <label class="control-label"><?php echo get_phrase('tipo_de_conta');?></label>
                        <div class="select">
                ...
                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                    <button class="btn btn-rounded btn-success btn-lg full-width" id="sub_admin" type="submit"><?php echo get_phrase('salvar');?></button>
                </div>
            </div>
         <?php echo form_close();?>    
        </div>
