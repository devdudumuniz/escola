		...
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big">
				<?php echo get_phrase('arquivo');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url();?>uploads/report_files/<?php echo $row['file'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('download');?></a>
			</div>
			<?php endif;?>
	        	...
	        	<?php $user1 = $row['user_id']; $user = explode("-", $user1);?>
                            <div class="ui-block-content">
                                <div class="widget w-about" style="text-align:center">
                                    ...
                                    <h4><?php echo $this->crud_model->get_name($user[0], $user[1]);?><br> <small><?php echo get_phrase('contato');?>:  <?php echo $this->db->get_where($user[0], array($user[0].'_id' => $user[1]))->row()->phone;?>.</small></h4>
