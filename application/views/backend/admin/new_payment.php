  ...
  <div class="content-i">
	...
	<div class="element-wrapper">
      ...
      <div class="element-box lined-primary shadow">
		  <h5 class="form-header"><?php echo get_phrase('detalhes da fatura');?></h5><br>
      ...
      <div class="element-box lined-success shadow">
		  <h5 class="form-header">
			<?php echo get_phrase('detalhes de pagamento');?>
		  </h5><br>
    		  <div class="row">
		        <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group label-floating">
                      	<label class="control-label"><?php echo get_phrase('quantia');?></label>
                ...
                <div class="form-group label-floating is-select">
                    ...
                    <div class="select">
                        <select name="status" required="">
					        ...
					        <option value="pending"><?php echo get_phrase('pendente');?></option>
                        </select>
                    </div>
                </div>
            </div>
		...
		<?php echo form_close();?>
		  	...
		  	<div class="tab-pane" id="bulk">
		  	    ...
		  	    <div class="row">
			        <div class="col-sm-6">
      <div class="element-box lined-primary shadow">
		  <h5 class="form-header"><?php echo get_phrase('detalhes de pagamento');?></h5><br>
