...
<div class="content-w">
    ...
    <div class="conty">
        <div class="os-tabs-w menu-shad">
	        <div class="os-tabs-controls">
	            <ul class="navs navs-tabs upper">
		            <li class="navs-item">
		                <a class="navs-links active" href="<?php echo base_url();?>admin/request_student/"><i class="os-icon picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i><span><?php echo get_phrase('relatórios');?></span></a>
		            </li>
		            <li class="navs-item">
		                <a class="navs-links" href="<?php echo base_url();?>admin/request/"><i class="os-icon picons-thin-icon-thin-0015_fountain_pen"></i><span><?php echo get_phrase('permissões');?></span></a>
		            </li>
	            </ul>
	        </div>
        </div>
                    ...
                    <table class="table table-padded">
                      <thead>
                        <tr>
                          ...
                          <th><?php echo get_phrase('classe');?></th>
                          <th><?php echo get_phrase('seção');?></th>
                        ...
                        <tr>
                            <td>
                              ...
                              <?php if($row['priority'] == 'media'):?>
                                <span class="status-pill yellow"></span><span><?php echo get_phrase('médio');?></span>
                              <?php endif;?>
      ...
      <div class="tab-pane" id="teachers">
		  <div class="element-wrapper">
                <h6 class="element-header">
                  <?php echo get_phrase('relatórios dos professores');?>
                </h6>
                <div class="element-box-tp">
		  <div class="table-responsive">
			<table class="table table-padded">
                      ...
                      <tbody>
                        ...
                        <?php if($row['priority'] == 'alta'):?>
					     ...
					     <?php endif;?>
                          ...
                          <td class="bolder">
                              <a href="<?php echo base_url();?>admin/view_report/<?php echo $row['report_code'];?>/" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0012_notebook_paper_certificate" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('ver detalhes');?>"></i></a>
                              <a  onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/request_student/delete_teacher/<?php echo $row['report_code'];?>" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('excluir');?>"></i></a>
                          </td>
                        </tr>
                        <?php endforeach;?>
			</tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="ui-block-title" style="background-color:#00579c">
          <h6 class="title" style="color:white"><?php echo get_phrase('adicionar relatório');?></h6>
        </div>
           ...
           <?php echo form_open(base_url() . 'admin/create_report/send/', array('enctype' => 'multipart/form-data')); ?>
              <div class="row">
                  ...
                  <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating is-select">
                                <label class="control-label"><?php echo get_phrase('prioridade');?></label>
                                <div class="select">
                                    <select name="priority" required="">
                                        <option value=""><?php echo get_phrase('selecionar');?></option>
						                <option value="baja"><?php echo get_phrase('baixo');?></option>
						                <option value="media"><?php echo get_phrase('médio');?></option>
						                <option value="alta"><?php echo get_phrase('alto');?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                  	        <label class="control-label"><?php echo get_phrase('arquivo');?></label>
                    ...
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                                <textarea class="form-control" rows="6" placeholder="<?php echo get_phrase('descrição');?>..." name="description" required=""></textarea>
                            </div>
                        </div>
                    </div>
