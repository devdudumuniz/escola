      ...
      <div class="content-box">
        <div class="row">
          ...
          <div class="col col-lg-3 col-md-3 col-sm-12 col-12">
            <div class="text-">
              <button class="btn btn-rounded btn-success btn-upper" data-target="#addroutine" data-toggle="modal" type="button">+ <?php echo get_phrase('add horário');?></button>
            </div>
          </div>
        </div>               
                    ...
                    <div class="pi-controls" style="text-align:right;">
                      <div class="pi-settings os-dropdown-trigger">
                        ...
                        <ul>
                          ...
                          <li>
                            <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/class_routine/delete/<?php echo $row2['class_routine_id'];?>"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('excluir');?></span></a>
                          </li>
                        </ul>
                      </div>
                    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="ui-block-title" style="background-color:#00579c">
          <h6 class="title" style="color:white"><?php echo get_phrase('adicionar horários');?> </h6>
        </div>
