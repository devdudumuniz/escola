												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('enquetes');?></a>
				                                                ...
				                                                <ul class="table-careers">
				                                                    ...
				                                                    ?>
					                                                    <li class="ui-block lists">
						                                                    ...
						                                                    <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/polls/delete2/<?php echo $poll['poll_code'];?>"><i style="font-size:18px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
					                                                    </li>
					                                               <?php endforeach;?>
				                                                </ul>
			                                                </div>
