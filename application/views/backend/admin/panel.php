                  ...
                  <div class="tab-content">
                    <div class="edu-wall-content ng-scope" id="new_post">
                      <div class="tab-pane active show">
                        ...
                        <div class="form-group with-icon label-floating is-empty" style="padding-left:10px;">
                          <textarea onkeyup="textAreaAdjust(this)" style="overflow:hidden" class="form-control" placeholder="<?php echo get_phrase('Oi');?> <?php echo $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->first_name;?> <?php echo get_phrase('o que publicar');?>" name="description" required=""></textarea>
                        ...
                        <div class="form-group" style="margin-bottom:-15px;">
                          ...
                          <label style="font-size:15px;" for="userfile"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <span><?php echo get_phrase('carregar imagem');?>...</span></label>
                        </div>
                        ...
                        <div class="add-options-message btm-post edupostfoot edu-wall-actions" style="padding:10px 5px;">
                          <a href="javascript:void(0);" class="options-message" onclick="post()" data-toggle="tooltip" data-placement="top"   data-original-title="<?php echo get_phrase('novidades');?>">
                            <i class="os-icon picons-thin-icon-thin-0032_flag"></i>
                          </a>
                          <a href="javascript:void(0);" class="options-message" onclick="poll()" data-toggle="tooltip" data-placement="top"   data-original-title="<?php echo get_phrase('enquetes');?>">
                          ...
                          <button class="btn btn-rounded btn-success" style="float:right"><i class="picons-thin-icon-thin-0317_send_post_paper_plane" style="font-size:12px"></i> <?php echo get_phrase('publicar');?></button>
                        </div>        
                        <?php echo form_close();?>
                      </div>                          
                    </div>
                    ...
                    <?php echo form_open(base_url() . 'admin/polls/create/' , array('enctype' => 'multipart/form-data'));?>
                      <div class="tab-pane active show"><br>
                        <div class="col-sm-12"><h5 class="form-header"><?php echo get_phrase('criar enquete');?></h5></div>
                        <div class="form-group">
                          <div class="col-sm-12">
                            <div class="form-group label-floating">
                              <label class="control-label"><?php echo get_phrase('pergunta');?></label>
                        ...
                        <div id="bulk_add_form">
                          <div id="student_entry">
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label class="col-form-label" for=""><?php echo get_phrase('opções');?></label>
                                <div class="input-group">
                                  <input class="form-control" name="options[]" placeholder="<?php echo get_phrase('opções');?>" type="text">
                        ...
                        <center><a href="javascript:void(0);" class="btn btn-rounded btn-primary btn-sm" onclick="append_student_entry()">+ <?php echo get_phrase('mais_opções');?></a></center><br>
                        <div class="form-group">
                          <div class="col-sm-12">
                            <div class="form-group label-floating is-select">
                              <label class="control-label"><?php echo get_phrase('usuários');?></label>
                              <div class="select">
                                <select name="user" id="slct">
                                  <option value=""><?php echo get_phrase('selecionar');?></option>
                                  <option value="all"><?php echo get_phrase('todos');?></option>
                                  ...
                                  <option value="teacher"><?php echo get_phrase('professores');?></option>    
                                </select>
                              </div>
                            </div>
                          </div>              
                    ...
                    <?php echo form_close();?>
                        <div class="add-options-message btm-post edupostfoot edu-wall-actions" style="padding:10px 5px;">
                          ...
                          <a href="javascript:void(0);" class="options-message" onclick="poll()" data-toggle="tooltip" data-placement="top"   data-original-title="<?php echo get_phrase('enquete');?>">
                            <i class="os-icon picons-thin-icon-thin-0385_graph_pie_chart_statistics"></i>
                          </a>
                          <a href="javascript:void(0);" class="options-message" onclick="video()" data-toggle="tooltip" data-placement="top"   data-original-title="<?php echo get_phrase('youtube_video');?>">
                            <i class="os-icon picons-thin-icon-thin-0593_video_play_youtube"></i>
                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_wall/<?php echo $news_code;?>');"><?php echo get_phrase('editar');?></a></li>
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')"  href="<?php echo base_url();?>admin/news/delete/<?php echo $news_code;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>
                  </div><hr>
                    ...
                    <article class="hentry post">
                      <div class="post__author author vcard inline-items">
                        ...
                        <div class="more">
                          <i class="icon-options"></i>                                
                          <ul class="more-dropdown">
                            <li><a href="<?php echo base_url();?>admin/view_poll/<?php echo $poll_code;?>/"><?php echo get_phrase('ir_para_detalhes');?></a></li>
                            <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/polls/delete/<?php echo $poll_code;?>"><?php echo get_phrase('excluir');?></a></li>
                          </ul>
                        </div>
                      </div><hr>
                      <div class="control-block-button post-control-button">
                        <a href="javascript:void(0);" class="btn btn-control" style="background-color:#99bf2d; color:#fff;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('enquetes');?>">
              ...
              <div class="sidebar__inner">
                ...
                <div class="ui-block paddingtel">
				    <div class="widget w-create-fav-page">
					    ...
					    <div class="content">
						    <h3 class="title"><?php echo get_phrase('bem-vindo ao painel do admin');?></h3>
					    </div>
				    </div>
			    </div>
                <div class="ui-block paddingtel" >
                                ...
                                <div class="user-w with-status min status-green">
                                  ...
                                  <div class="user-name">
                                    ...
                                    <?php if($row['type'] == 'student'):?>
                                      <span class="badge badge-warning"><?php echo get_phrase('Estudante');?></span>
                                    <?php endif;?>
                                    <?php if($row['type'] == 'accountant'):?>
                                      <span class="badge badge-info"><?php echo get_phrase('contador');?></span>
                                    <?php endif;?>
                                    ...
                                    <?php if($row['type'] == 'teacher'):?>
                                      <span class="badge badge-success"><?php echo get_phrase('professor');?></span>
                                    <?php endif;?>
                                    </div>
                                  </div>            
                                </div>
                  ...
                  <div class="ui-block paddingtel">
                    ...
                    <h6 class="title"><?php echo get_phrase('contabilidade');?></h6>
                  </div>
                  <div class="ui-block-content">
            ...
            <div class="crumina-sticky-sidebar">
              <div class="sidebar__inner">
                <div class="ui-block paddingtel">
                  <div class="today-events calendar ">
                    <div class="today-events-thumb">
                      ...
                      ?>
                        ...
                        <div class="day-week"><?php echo strftime('%A');?></div>
                        <div class="month-year" style="color:#FFF"><?php echo strftime(' %B de %Y', strtotime('today'));?>.</div>
                      </div>
                    </div>
                    <div class="list">
                      <div class="control-block-button">
                        <a href="<?php echo base_url();?>admin/calendar/" class="btn btn-control bg-breez" style="padding:0;display:flex;justify-content:center;">
                          <i style="margin:auto;" class="fa fa-plus text-white"></i>
                        </a>
                      </div>
                      <?php $date = date('Y-m-d')." "."00:00:00";
                        ...
                        <?php endforeach;?>
                        <?php else:?>
                        <center><div style="padding-bottom : 75px;padding-top :75px;"><p><?php echo get_phrase('sem eventos de hoje');?></p><img src="<?php echo base_url();?>uploads/calendar.png" width="20%"/></div></center>
                        <?php endif;?>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="ui-block paddingtel">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <?php 
                        ...
                        $var++;
                      ?>
                        <li data-target="#myCarousel" data-slide-to="<?php echo $var-1;?>" class="<?php if($var == 1) echo "ativo";?>"></li>
                      <?php endforeach;?>
                      </ol>
                      <div class="carousel-inner">
                        <?php foreach($birthdays as $day): $var1++;?>
                          <div class="item <?php if($var1 == 1) echo "ativo";?>">
                  ...
                  <div class="ui-block paddingtel">
                    <div class="ui-block-title"><h6 class="title"><?php echo get_phrase('alunos_ausentes');?></h6></div>
                    <?php
                    ...
                    <?php else:?>
                    <center>
                      <div style="padding-bottom : 75px;padding-top :75px;"><p><?php echo get_phrase('sem alunos ausentes');?></p><img src="<?php echo base_url();?>uploads/plan.png" width="20%"></div></center>
                    <?php endif;?>
                    <div class="header-spacer"></div>
                  </div><br>
                </div>
...
var myChart = new Chart(ctx, {
    type: 'pie',
    data: {
        labels: ['<?php echo get_phrase('despesa');?>', '<?php echo get_phrase('renda');?>'],
        datasets: [{
            label: '#<?php echo get_phrase('contabilidade');?>',
