  				 ...
  				 <div class="col-lg-12">
						<div class="element-wrapper">
							...
							<?php echo form_open(base_url() . 'admin/polls/create_wall/' , array('enctype' => 'multipart/form-data'));?>
		  					<h5 class="form-header"><?php echo get_phrase('criar enquete');?></h5><br>
		  					<div class="form-group">
			  					<div class="col-sm-12">
			  						<label class="col-form-label" for="" style="text-align: left;"><?php echo get_phrase('pergunta');?></label>
			  						<div class="input-group">
										<div class="input-group-addon">
											<i class="picons-thin-icon-thin-0382_graph_columns_statistics"></i>
				  						</div>
										<input class="form-control" placeholder="<?php echo get_phrase('pergunta');?>" name="question" required="" type="text">
									</div>
			  					</div>
							</div>
							<div id="bulk_add_form">
									...
									<div class="form-group">
			  							<div class="col-sm-12">
			  								<label class="col-form-label" for=""><?php echo get_phrase('opções');?></label>
			  									<div class="input-group">
													<input class="form-control" name="options[]" placeholder="<?php echo get_phrase('opções');?>" required="" type="text">
          					...
          					<center><a href="javascript:void(0);" class="btn btn-rounded btn-success btn-sm" onclick="append_student_entry()">+ <?php echo get_phrase('mais_opções');?></a></center>							<br>
							<div class="form-group">
				            	<div class="col-sm-12">
		  					...
		  					<div class="form-buttons-w">
								<button class="btn btn-primary btn-rounded" type="submit"> <?php echo get_phrase('salvar');?></button>
		  					</div>
						<?php echo form_close();?>
		  			</div>
				</div>
