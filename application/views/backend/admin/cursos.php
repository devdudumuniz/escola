                                              ...
                                              <div class="os-tabs-controls">
                                                <ul class="navs navs-tabs upper">
                                                  <?php 
                                                    ...
                                                    <li class="navs-item">
                                                      <a class="navs-links <?php if($active == 1) echo "ativo";?>" data-toggle="tab" href="#tab<?php echo $rows['section_id'];?>"><?php echo get_phrase('seção');?> <?php echo $rows['name'];?></a>
                                                    </li>
                                                    <?php endforeach;?>
                                                  <?php endif;?>
                                                </ul>
                                                    ...
                                                    <div class="friend-item friend-groups">
                                                        ...
                                                        <div class="more">
                                                            ...
                                                            <ul class="more-dropdown">
                                                                ...
                                                                <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>admin/courses/delete/<?php echo $row2['subject_id'];?>"><?php echo get_phrase('excluir');?></a></li>
                                                            </ul>
                                                        </div>
