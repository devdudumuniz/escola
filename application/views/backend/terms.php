...
<html><style>
  ...
  <head>
    <title><?php echo get_phrase('termos e condições');?> | <?php echo $this->db->get_where('settings', array('type' => 'system_title'))->row()->description;?></title>
    <meta charset="utf-8">
      ...
      <div class="steps-w">
        <div class="step-contents">
          <div class="step-content active" id="stepContent1">
              <h4><?php echo get_phrase('termos e condições');?></h4><hr>
            <div class="row">
            <br>
