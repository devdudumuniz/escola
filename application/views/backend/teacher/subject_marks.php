		 ...
		 <div class="pipeline-item">
		  ...
		  <div class="pi-body">
			...
			<div class="pi-info">
			  ...
			  <div class="pi-sub">
				<?php echo get_phrase('classe');?>: <?php echo $this->crud_model->get_class_name($class_id); ?><br>
        		<?php echo get_phrase('seção');?>: <?php echo $this->db->get_where('section' , array('section_id' => $section_id))->row()->name; ?>
			  </div>
			</div>
		  </div>
		</div>
