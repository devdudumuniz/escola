                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>teacher/homework_edit/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/"><?php echo get_phrase('editar');?></a></li>
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url(); ?>teacher/homework/delete/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/<?php echo $data;?>/"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>                
                  </div>                
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>teacher/exam_edit/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/"><?php echo get_phrase('editar');?></a></li>
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>teacher/manage_exams/delete/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/<?php echo $data;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>
                  </div>                
                  <div class="edu-posts cta-with-media morado">
                    <div class="cta-content">
                      ...
                      <a href="<?php echo base_url();?>teacher/examroom/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/"><button class="btn btn-rounded btn-posts green"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('view_exam');?></button></a>
                    </div>
                  </div>              
                  <div class="control-block-button post-control-button">                
                ...
                <article class="hentry post thumb-full-width">
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>teacher/study_material/delete/<?php echo $this->db->get_where('document', array('document_id' => $wall['homework_id']))->row()->document_id;?>/<?php echo $data;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>                
                  </div>                
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>teacher/edit_forum/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/"><?php echo get_phrase('editar');?></a></li>
                        <li><a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url(); ?>teacher/forum/delete/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/<?php echo $data;?>"><?php echo get_phrase('excluir');?></a></li>
                      </ul>
                    </div>
                  </div>                
