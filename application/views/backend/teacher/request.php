  ...
  <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="navs navs-tabs upper">
            <li class="navs-item">
              <a class="navs-links active" data-toggle="tab" href="#permissions"><i class="os-icon picons-thin-icon-thin-0015_fountain_pen"></i><span><?php echo get_phrase('permissões');?></span></a>
            </li>
            <li class="navs-item">
  ...
  <div class="content-i">
    <div class="content-box">
        ...
        <div class="element-wrapper">
				...
				<th><?php echo get_phrase('arquivo');?></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
        	...
        	?>   
				<tr>
				    	<td>
					    <?php if($row['status'] == 2):?>
                                <span class="status-pill red"></span><span><?php echo get_phrase('rejeitado');?></span>
                              <?php endif;?>
                              <?php if($row['status'] == 0):?>
                                <span class="status-pill yellow"></span><span><?php echo get_phrase('pendente');?></span>
                              <?php endif;?>
                              <?php if($row['status'] == 1):?>
                                <span class="status-pill green"></span><span><?php echo get_phrase('aprovado');?></span>
                              <?php endif;?>
					</td>
          ...
          <div class="element-wrapper">
            <div class="element-box lined-primary">
			  ...
			  <div class="form-group">
				  <label> <?php echo get_phrase('descrição');?></label><textarea name="description" class="form-control" required="" rows="4"></textarea>
				</div>
			  <div class="row">
				  <div class="col-sm-6">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('de');?></label>
