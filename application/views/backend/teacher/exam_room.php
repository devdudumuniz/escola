...
<?php if($online_exam_id != ""):?>
    ...
    <div class="os-tabs-controls">
      ...
      <li class="navs-item">
        <a class="navs-links active" href="<?php echo base_url();?>teacher/examroom/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('detalhes da prova');?></span></a>
      </li>
      <li class="navs-item">
      ...
      <li class="navs-item">
        <a class="navs-links" href="<?php echo base_url();?>teacher/exam_edit/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo get_phrase('editar');?></span></a>
      </li>
      </ul>
    </div>
    </div>
                ...
                <table  class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;"><div><?php echo get_phrase('opções');?></div></th>
                        </tr>
                    </thead>
                    <tbody>
                                    ...
                                    <td><span class="badge badge-success">
                                        <?php 
                                            if($added_question['type'] == "fill_in_the_blanks") {
                                                echo get_phrase('espaços em branco');
                                            } else if($added_question['type'] == "multiple_choice"){
                                                echo get_phrase('múltipla escolha');
...
<div style="overflow-x:auto;">
                <table  class="table table-bordered">
                    <tbody>
                        <tr>
                            <td><b><?php echo get_phrase('título');?></b></td>
                        ...
                        <tr>
                            ...
                            <td><b><?php echo get_phrase('porcentagem necessária');?></b></td>
        ...
        <div class="pipeline white lined-danger">
            <div class="panel-heading">
                <h5 class="panel-title" >
                    <?php echo get_phrase('add pergunta');?>
                </h5>
            </div>
            <div class="panel-body">   
                            ...
                            <label class="control-label"><?php echo get_phrase('tipo de pergunta');?></label>
                                <div class="select">
                                    <select name="question_type" id="question_type">
                                        ...
                                        <option value="multiple_choice"><?php echo get_phrase('múltipla escolha');?></option>
                                        <option value="true_false"><?php echo get_phrase('true_false');?></option>
                                        <option value="fill_in_the_blanks"><?php echo get_phrase('espaços em branco');?></option>
