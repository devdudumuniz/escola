                  ...
                  <div class="friend-item-content">
                      ...
                      <div class="friend-avatar">
                        ...
                        <div class="author-content">
                          ...
                          <div class="country"><b><?php echo get_phrase('seções');?>:</b> <?php $sections = $this->db->get_where('section', array('class_id' => $cl['class_id']))->result_array(); foreach($sections as $sec):?> <?php echo $sec['name']." "."|";?><?php endforeach;?></div>
                        </div>
                      </div>        
                    </div>
                  </div>
