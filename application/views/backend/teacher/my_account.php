											...
											<div class="row">
												<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
													<ul class="widget w-personal-info item-block">
														...
														<li>
															<span class="title"><?php echo get_phrase('identificação');?>:</span>
                						...
                						<div class="help-support-block">
											...
											<ul class="help-support-list">
												<li>
													...
													<a href="<?php echo base_url();?>teacher/my_account/"><?php echo get_phrase('informações_pessoais');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url();?>teacher/teacher_update/"><?php echo get_phrase('atualizar informações');?></a>
												</li>
											</ul>
										</div>
									</div>
									<h4 class="text-center"><?php echo get_phrase('suas contas vinculadas');?></h4>
      ...
      <div class="pricing-plan col-sm-6">
        ...
        <div class="plan-body"><br><br>
          <div class="plan-btn-w">
            ...
            <?php else:?>
              <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>teacher/my_account/remove_facebook/"><?php echo get_phrase('desvincular');?></a>
            <?php endif;?>
          </div>
        </div>
      </div>
      <div class="pricing-plan col-sm-6">
        ...
        <div class="plan-body"><br><br>
          <div class="plan-btn-w">
            ...
            <?php else:?>
              <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>teacher/my_account/remove_google/"><?php echo get_phrase('desvincular');?></a>
            <?php endif;?>
          </div>
        </div>
      </div>
