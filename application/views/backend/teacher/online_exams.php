                  ...
                  <div class="table-responsive">
                    <table class="table table-padded">
                        <thead>
                          ...
                          <tr>
                            <td>
                             <button class="btn btn-<?php echo $row['status'] == 'published' ? 'success' : 'warning'; ?> btn-sm"><?php if($row['status'] == "published") echo get_phrase('published'); else if($row['status'] == "pending") echo get_phrase('pendente'); else echo get_phrase('expired');?></button>
                            </td>
                            <td><span><?php echo $row['title'];?></span></td>
                            <td><span><?php echo '<b>'.get_phrase('data').':</b> '.date('M d, Y', $row['exam_date']).'<br>'.'<b>'.get_phrase ('hora').':</b> '.$row['time_start'].' - '.$row['time_end'];?></span></td>
                            <td class="bolder">
                                ...
                                <?php if ($row['status'] == 'pending'): ?>
                                    <a href="<?php echo base_url();?>teacher/manage_online_exam_status/<?php echo $row['online_exam_id'];?>/published/<?php echo $data;?>/" onclick="return confirm('<?php echo get_phrase('confirm_publish');?>')" class="btn btn-info btn-sm"><?php echo get_phrase('publicar');?></a><br>
                                ...
                                <?php endif; ?>
                                <a class="btn btn-danger btn-sm" onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>teacher/manage_exams/delete/<?php echo $row['online_exam_id'];?>/<?php echo $data;?>/">Eliminar</a>
                            </td>
                          </tr>
                        <?php endforeach;?>
                      </tbody>
