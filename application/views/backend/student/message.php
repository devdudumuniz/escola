				    ...
				    <div class="tab-content">
                        <div class="os-tabs-w bg-white">
                            <ul class="navs navs-tabs upper centered">
                                <li class="navs-item">
                                    <a class="navs-links <?php if($page_name == 'message' && $message_inner_page_name != 'message_new') echo "ativo";?>" href="<?php echo base_url();?>student/message/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0306_chat_message_discussion_bubble_conversation" style="color:#7807D6"></i><span><?php echo get_phrase('bate-papo');?></span></a>
                                </li>
                                <li class="navs-item">
                                    <a class="navs-links <?php if($message_inner_page_name == 'message_new') echo "ativo";?>" href="<?php echo base_url();?>student/message/message_new/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new" style="color:#7807D6"></i><span><?php echo get_phrase('escrever');?></span></a>
                                </li>
                                <li class="navs-item">
                                    <a class="navs-links" href="<?php echo base_url();?>student/group/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0719_group_users_circle" style="color:#7807D6"></i><span><?php echo get_phrase('grupos');?></span></a>
                                </li>
                            </ul>
                        </div>
                          					...
                          					<div class="last-message">
                            					<?php if($user_to_show_type =='admin') : ?>
                           						...
                           						<?php if($user_to_show_type =='student') : ?>
                             						<a class="badge badge-secondary" href="<?php echo base_url(); ?>student/message/message_read/<?php echo $row['message_thread_code']; ?>" style="color:white"><?php echo get_phrase('Estudante');?></a>
                           						<?php endif;?>
                           						<?php if($user_to_show_type =='teacher') : ?>
                             						<a class="badge badge-warning" href="<?php echo base_url(); ?>student/message/message_read/<?php echo $row['message_thread_code']; ?>" style="color:white"><?php echo get_phrase('professor');?></a>
                           						<?php endif;?>
