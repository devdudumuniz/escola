          							...
          							<div class="ui-block">
										...
										<div class="ui-block-content">
										    ...
										    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">								
						   				    ...
						   				    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">								
    											<div class="form-group label-floating">
												    <label class="control-label"><?php echo get_phrase('atualizar_senha');?></label>
						    			    ...
						    			    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">	
						    			    <button class="btn btn-info btn-rounded pull-right" type="submit"><?php echo get_phrase('atualizar');?></button>
						    			    </div>
									    </div>
										</div>
										<?php echo form_close();?>
