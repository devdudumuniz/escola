    ...
    <div class="content-box">
            ...
            <td><a class="btn btn-rounded btn-sm btn-primary" style="color:white" href="<?php echo base_url();?>student/subject_marks/<?php echo $data;?>/<?php echo $row2['exam_id'];?>/"><?php echo get_phrase('view_all');?></a></td>
      						...
      						<div class="form-buttons-w text-right">
                                <a target="_blank" href="<?php echo base_url();?>student/marks_print_view/<?php echo base64_encode($this->session->userdata('login_user_id').'-'. $row2['exam_id']);?>/"><button class="btn btn-rounded btn-success" type="submit"><i class="picons-thin-icon-thin-0333_printer"></i>  <?php echo get_phrase('imprimir');?></button></a>
                            </div>
    					</div>
  					</div>
				</div>	
