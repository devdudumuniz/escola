    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url();?>student/subject_marks/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?php echo get_phrase('marcas');?></span></a>
          </li>
          <li class="navs-item">
                ...
                <article class="hentry post thumb-full-width">                
                  ...
                  <div class="edu-posts cta-with-media morado">
                    <div class="cta-content">
                      ...
                      <a href="<?php echo base_url();?>student/online_exams/<?php echo $data;?>/"><button class="btn btn-rounded btn-posts green"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('go_to_exams');?></button></a>
                    </div>
                  </div>              
                  <div class="control-block-button post-control-button">                
