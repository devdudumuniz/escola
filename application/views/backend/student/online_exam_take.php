  ...
  <div class="ui-block responsive-flex1200">
    <div class="ui-block-title">
      <h4><?php echo $online_exam_row->title;?></h4>
        <h4><b><?php echo get_phrase('duration');?></b>: <?php echo ($online_exam_row->duration / 60).' '.get_phrase('minutos');?></h4>
            <div style="height:30px; font-size:25px; font-weight:200; color: #212121;" id="timer_value">
        <span id="hour_timer"> 0 </span>
        <span style="font-size:20px;"><?php echo get_phrase ('hora');?> </span>
                          ...
                          <div class="pipeline white lined-primary">            
                            <div class="pipeline-header">
                              <h5><b><?php echo $count++;?>.</b>  <?php echo ($question['type'] == 'fill_in_the_blanks') ? str_replace('^', '__________', $question['question_title']) : $question['question_title'];?> 
                                </h5><span><?php echo get_phrase('marca');?>: <?php echo $question['mark'];?></span>
                            </div>
