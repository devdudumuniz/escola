  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
        										...
        										<li class="active"><a href="<?php echo base_url();?>student/recent/"><i class="picons-thin-icon-thin-0117_folder_documents_revert_history"></i><span><?php echo get_phrase('recentes');?></span></a></li>
            											...
            											<div class="message-head">
              												<div class="user-w with-status status-green">
                												<div class="user-name">
                  													...
                  													<div class="user-role"><?php $this->db->where('fileorder', date('d/m/Y')); $this->db->where('user_type', 'student'); $this->db->where('user_id', $this->session->userdata('login_user_id')); echo $this->db->count_all_results('file');?> <?php echo get_phrase('arquivos');?>.</div>
                												</div>
              												</div>
            											</div>
