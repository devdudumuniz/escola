                    ...
                    <div class="app-email-i">
                      <div class="ae-side-menu">
                          ...
                          <ul class="ae-main-menu">
                            ...
                            <li><a href="<?php echo base_url();?>student/all/"><i class="picons-thin-icon-thin-0130_structure_map_files"></i><span><?php echo get_phrase('todos');?></span></a></li>
                            ...
                            <li class="active"><a href="<?php echo base_url();?>student/folders/"><i class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('seus_arquivos');?></span></a></li>
                          </ul>
                      </div>
                                    ...
                                    <ul class="widget w-friend-pages-added notification-list friend-requests">
                                      ...
                                      <li class="inline-items">
                                        ...
                                        <div class="notification-event">
                                          ...
                                          <a onClick="return confirm('<?php echo get_phrase('confirmar exclusão');?>')" href="<?php echo base_url();?>student/folders/delete/<?php echo $row['folder_id'];?>"><i style="font-size:15px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
                                        </div>
