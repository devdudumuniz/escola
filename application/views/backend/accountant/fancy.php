        ...
        <div class="control-block">
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                    ...
                    <a href="<?php echo base_url();?>accountant/message/" class="view-all bg-info"><?php echo get_phrase('ver todas as mensagens');?></a>
                </div>
            </div>
            <div class="control-icon more has-items">
                ...
                ?>
                  ...
                  <?php endforeach;?>
                    ...
                    <a href="<?php echo base_url();?>accountant/notifications/" class="view-all bg-info"><?php echo get_phrase('ver todas as notificações');?></a>
                </div>
            </div>
