        ...
        <div class="os-tabs-w menu-shad">
          <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
              ...
              <li class="navs-item">
                <a class="navs-links active" href="<?php echo base_url();?>accountant/students_payments/"><i class="os-icon picons-thin-icon-thin-0426_money_payment_dollars_coins_cash"></i><span><?php echo get_phrase('pagamentos');?></span></a>
              </li>
              <li class="navs-item">
  ...
  <div class="content-i"> 
	...
	<div class="element-wrapper">
		...
		<div class="tab-pane active" id="invoices">
		    <a class="btn btn-rounded btn-success text-white" href="<?php echo base_url();?>accountant/new_payment/"><?php echo get_phrase('novo_pagamento');?></a><br><br>
		    <div class="element-wrapper">
