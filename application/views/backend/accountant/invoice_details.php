...
<div class="content-i">
	<div class="content-box">
	  <div class="element-wrapper">
	      ...
	      <button type="button" class="btn btn-rounded btn-success" onclick="Print('invoiceid')"><?php echo get_phrase('imprimir');?></button>
	      <br><br>
		  ...
		  <div class="infos">
			<div class="info-1">
			  ...
			  <div class="company-extra" style="color:#000;">
				<?php echo get_phrase('contato');?>: <?php echo $this->db->get_where('settings', array('type' => 'phone'))->row()->description;?>
			  </div>
			</div>
			  ...
			  <table class="table">
				<thead>
				  <tr>
					...
					<th class="text-right"><?php echo get_phrase('quantia');?></th>
				  </tr>
				</thead>
				<tbody>
				  <tr>
