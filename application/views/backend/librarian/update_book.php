	...
	<div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
		  <ul class="navs navs-tabs upper">
			<li class="navs-item">
			  <a class="navs-links active" href="<?php echo base_url();?>librarian/library/"><i class="os-icon picons-thin-icon-thin-0017_office_archive"></i><span><?php echo get_phrase('biblioteca');?></span></a>
			</li>
			<li class="navs-item">
			  <a class="navs-links" href="<?php echo base_url();?>librarian/book_request/"><i class="os-icon picons-thin-icon-thin-0086_import_file_load"></i><span><?php echo get_phrase('solicitação de livro');?></span></a>
			</li>
		  </ul>
		</div>
	  </div>
		  ...
		  <div class="row">
		       <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo get_phrase('total de cópias');?></label>
                ...
                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
		  		...
		  		<div class="form-buttons-w">
					<button class="btn btn-primary btn-rounded" type="submit"> <?php echo get_phrase('atualizar');?></button>
		  		</div>	
		<?php echo form_close();?>
	  </div>
	</div>
