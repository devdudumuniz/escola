                    ...
                    <table class="table table-padded">
                      ...
                      <tbody>
			           ...
			           <tr>
                        ...
                        <td>
                            <?php if($row['status'] == 0) { ?>
                                <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('aprovar');?>" onClick="return confirm('<?php echo get_phrase('confirmar_aprovação');?>')" href="<?php echo base_url();?>librarian/book_request/accept/<?php echo $row['book_request_id'];?>"><i style="color:gray" class="picons-thin-icon-thin-0154_ok_successful_check"></i></a>
						        <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('rejeitar');?>" onClick="return confirm('<?php echo get_phrase('confirmar_rejeição');?>')" href="<?php echo base_url();?>librarian/book_request/reject/<?php echo $row['book_request_id'];?>"><i style="color:gray" class="picons-thin-icon-thin-0153_delete_exit_remove_close"></i></a>
