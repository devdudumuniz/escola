<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
    class Admin extends CI_Controller
    {
        ...
        function meet($param1 = '', $param2 = '', $param3 = '')
        {
            ...
            if($param1 == 'update')
            {
                ...
                $this->session->set_flashdata('flash_message' , get_phrase('atualizado com sucesso'));
        ...
        function news($param1 = '', $param2 = '', $param3 = '') 
        {
            ...
            $page_data['page_title'] = get_phrase('novidades');
            $this->load->view('backend/index', $page_data);
        }
        ...
        function pending($param1 = '', $param2 = '')
        {
            ...
            $page_data['page_title'] = get_phrase('usuários pendentes');
            $this->load->view('backend/index', $page_data);
        }
    ...
    function students_report($param1 = '', $param2 = '')
    {
      ...
      $page_data['page_title']  = get_phrase('relatório dos alunos');
      $this->load->view('backend/index', $page_data);
    }
    ...
    function all($class_id = '', $section_id = '')
    {
      ...
      $page_data['page_title']  = get_phrase('meus arquivos');
      $this->load->view('backend/index', $page_data);
    }
    ...
    function librarian($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('bibliotecários');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function new_payment($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('novo_pagamento');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function recent()
    {
        ...
        $page_data['page_title'] =  get_phrase('arquivos_recentes');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function accountant($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('contadores');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function academic_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('configurações acadêmicas');
    ...
    function new_student($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('admissões');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function users($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title']                = get_phrase('usuários');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function Students($id = '')
    {
      ...
      $page_data['page_title']  = get_phrase('alunos');
    ...
    function accountant_update($accountant_id = '')
    {
        ...
        $page_data['page_title'] =  get_phrase('atualizar informações');
        $page_data['accountant_id']  =  $accountant_id;
        $this->load->view('backend/index', $page_data);
    }
    ...
    function teachers($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('professores');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function parents($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']  = get_phrase('pais');
    ...
    function marks()
    {
        ...
        $page_data['page_title'] = get_phrase('marcas');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function notify($param1 = '', $param2 = '')
    {
      ...
      if($param1 == 'send_emails')
      {
        ...
        $this->session->set_flashdata('flash_message' , "E -mails enviados corretamente");
      ...
      $page_data['page_title'] = get_phrase('notificações');
      $this->load->view('backend/index', $page_data);
    }
    ...
    function delete_student($student_id = '', $class_id = '') 
    {
        ...
        $tables = array('Aluno', 'Comparecimento', 'Matricular', 'Fatura', 'Marca', 'Forma de pagamento', 'students_request', 'reporte_alumnos');
    ...
    {        
        ...
        foreach($attendance_of_students as $row) 
        {
            ...
            if ($attendance_status == 2) 
            {
                ...
                $message        = 'Seu filho' . ' ' . $student_name . ' está ausente hoje.';
                if($notify == 1)
                {
                    if ($sms_status == 'msg91') 
                    {
    ...
    function email($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('configurações de e-mail');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function translate($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('traduzir');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function polls($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('enquetes');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function teacher_routine()
    {
        ...
        $page_data['teacher_id']  = $teacher_id;
        $page_data['page_title'] = get_phrase('rotina do professor');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function student_profile_attendance($student_id = '', $param1='', $param2 = '', $param3 = '', $param4 = '')
    {
        ...
        $page_data['page_title'] =  get_phrase('frequência do aluno');
        $page_data['student_id'] =  $student_id;
    ...
    function student_profile_report($student_id = '', $param1='')
    {
        ...
        $page_data['page_title'] =  get_phrase('comportamento');
        $page_data['student_id'] =  $student_id;
        $this->load->view('backend/index', $page_data);
    }
    ...
    function book_request($param1 = "", $param2 = "")
    {
        ...
        $data['page_title'] = get_phrase('solicitação de livro');
        $this->load->view('backend/index', $data);
    }
    ...
    function request($param1 = "", $param2 = "")
    {
        ...
        $data['page_title'] = get_phrase('permissões');
        $this->load->view('backend/index', $data);
    }
    ...
    function request_student($param1 = "", $param2 = "")
    {
        ...
        $data['page_title'] = get_phrase('relatórios');
        $this->load->view('backend/index', $data);
    }
    ...
    function invoice_details($id = '')
    {
        ...
        $page_data['page_title'] = get_phrase('detalhes da fatura');
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if($param1 == 'excel')
        {
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('A1', get_phrase('primeiro_nome'));
            $objPHPExcel->getActiveSheet()->setCellValue('B1', get_phrase('último_nome'));
            $objPHPExcel->getActiveSheet()->setCellValue('C1', get_phrase('nome de usuário'));
            $objPHPExcel->getActiveSheet()->setCellValue('D1', get_phrase('email'));
            $objPHPExcel->getActiveSheet()->setCellValue('E1', get_phrase('phone'));
            $objPHPExcel->getActiveSheet()->setCellValue('F1', get_phrase('sexo'));
            $objPHPExcel->getActiveSheet()->setCellValue('G1', get_phrase('classe'));
            $objPHPExcel->getActiveSheet()->setCellValue('H1', get_phrase('seção'));
    ...
    function student_promotion($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title']    = get_phrase('promoção estudantil');
    ...
    function courses($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('assuntos');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function section($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('seções');
        $page_data['class_id']   = $class;
        $this->load->view('backend/index', $page_data);    
    }
    ...
    function get_class_section($class_id = '')
    {
        ...
        echo '<option value="">' . get_phrase('selecionar') . '</option>';
    ...
    function tab_sheet($class_id = '' , $exam_id = '', $section_id = '') 
    {
        ...
        $page_data['page_title'] = get_phrase('folha de classificação');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function looking_routine()
    {
        ...
        $page_data['id']  =   $id;
        $page_data['page_title'] = get_phrase('rotina de exame');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function class_routine_view($param1 = '', $param2 = '')
    {
	   ...
	   $end = $_POST['Event'][2];
        ...
        $page_data['id']  =   $id;
        $page_data['page_title'] = get_phrase('rotina de classe');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function attendance()
    {
        ...
        $page_data['page_title'] =  get_phrase('atendimento');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function get_section($class_id = '') 
    {
     ...
     function attendance_report($param1 = '', $param2 = '', $param3 = '', $param4 = '') 
     {
        ...
        $page_data['page_title']   = get_phrase('relatório_de_atendimento');
        $this->load->view('backend/index',$page_data);
     }
    ...
    function accounting_report($param1 = '', $param2 = '')
    {
      ...
      $page_data['page_title']  = get_phrase('relatório de contabilidade');
      $this->load->view('backend/index', $page_data);
    }
    ...
    function calendar($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('calendário');
        $this->load->view('backend/index', $page_data); 
    }
    ...
    function payments($param1 = '' , $param2 = '' , $param3 = '') 
    {
        ...
        $page_data['page_title'] = get_phrase('pagamentos');
        $this->load->view('backend/index', $page_data); 
    }
    ...
    function expense($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('despesa');
        $this->load->view('backend/index', $page_data); 
    }
     ...
     function teacher_attendance()
    {
        ...
        $page_data['page_title'] =  get_phrase('frequência do professor');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function teacher_attendance_report() 
    {
        if ($this->session->userdata('admin_login') != 1) 
        {
         ...
         $page_data['page_title']   = get_phrase('relatório de atendimento do professor');
         $this->load->view('backend/index',$page_data);
     }
    ...
    function school_bus($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('ônibus_escolar');
        $this->load->view('backend/index', $page_data); 
    }
    ...
    function classrooms($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']  = get_phrase('salas de aula');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('configurações do sistema');
        $page_data['settings']   = $this->db->get('settings')->result_array();
        $this->load->view('backend/index', $page_data);
    }
    ...
    function library($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('biblioteca');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function files($task = "", $code = "")
    {
        ...
        $data['page_title']             = get_phrase('meus arquivos');
        $this->load->view('backend/index', $data);
    }
}