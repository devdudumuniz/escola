...
class Teacher extends CI_Controller
{
    ...
    function student_report($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('relatórios');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function files($task = "", $code = "")
    {
        ...
        $data['page_title']             = get_phrase('seus_arquivos');
    ...
    function folders($task = '', $param2 = '')
    {
      ...
      $page_data['page_title']             = get_phrase('seus_arquivos');
    ...
    function manage_attendance_view($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        $page_data['section_id'] = $section_id;
        $page_data['page_title'] = get_phrase('atendimento') . ' ' . $class_name . ' : ' . get_phrase('seção') . ' ' . $section_name;
        $this->load->view('backend/index', $page_data);
    }
